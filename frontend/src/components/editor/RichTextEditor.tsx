    ...
    <>
      <div className="relative rounded-lg sm:rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 w-full">
        ...
        <div
          ...
          onBlur={handleBlur}
          data-placeholder={placeholder}
          className={`min-h-[100px] sm:min-h-[120px] lg:min-h-[140px] max-h-[180px] sm:max-h-[200px] lg:max-h-[220px] overflow-y-auto px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base outline-none text-gray-900 dark:text-white bg-white dark:bg-gray-800 rich-editor-content`}
        />
        ...
        <style>{`
          ...
          /* Rich Editor Content Styles - Fix for bullet points */
          ...
          .rich-editor-content li::before {
            display: none !important; /* Prevent any pseudo-element from interfering */
          }
          ...
          /* Override any potential global styles that hide list markers */
          .rich-editor-content [contenteditable] ul,
          .rich-editor-content [contenteditable] ol {
            all: revert !important;
          }

          .rich-editor-content [contenteditable] li {
            all: revert !important;
          }

          /* Dark mode adjustments */
          .dark .rich-editor-content ul,
          .dark .rich-editor-content ol {
            color: inherit !important;
          }

          /* When editor is focused */
          .rich-editor-content:focus ul,
          .rich-editor-content:focus ol {
            outline: none;
          }
