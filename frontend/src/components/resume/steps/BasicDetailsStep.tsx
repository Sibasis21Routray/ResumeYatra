...
export function BasicDetailsStep({
  ...
  const renderField = (field: FieldConfig) => {
    ...
    const commonClasses = `w-full pl-2 sm:pl-3 pr-8 sm:pr-10 py-1.5 sm:py-2 bg-bg-primary dark:bg-dark-bg-primary border border-light-border dark:border-dark-border rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0 transition-all duration-200 text-text-primary dark:text-dark-text-primary placeholder-gray-300 dark:placeholder-gray-500 shadow-sm hover:shadow-md hover:border-accent dark:hover:border-dark-accent text-sm sm:text-base ${error
