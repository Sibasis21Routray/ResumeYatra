...
const StyledInput = ({
    ...
    let baseInputClass = `w-full ${icon ? 'pl-10' : 'pl-3'} pr-${characterCount ? '16' : '4'} py-2.5 bg-bg-primary dark:bg-dark-bg-primary border rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0 transition-all duration-200 text-text-primary dark:text-dark-text-primary placeholder-gray-300 dark:placeholder-gray-500 shadow-sm hover:shadow-md text-sm sm:text-base`;
