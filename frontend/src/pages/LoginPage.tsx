        ...
        <div className="bg-white/90 backdrop-blur-xl border border-white/50 rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(1,70,125,0.3)] p-10 md:p-12 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-[#01467d]/70 ml-1">
                Email
              </label>
            ...
            <div className="group space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="text-xs font-bold uppercase tracking-widest text-[#01467d]/70">
                  Password
                </label>
                <button
                  type="button"
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-600 text-sm">
              ...
              <Link
                to={`/register${searchParams.get("resumeId") ? `?resumeId=${searchParams.get("resumeId")}` : ''}`}
                className="relative group font-bold text-[#01467d] hover:text-[#dea42c] transition-colors"
              >
                Sign-up
