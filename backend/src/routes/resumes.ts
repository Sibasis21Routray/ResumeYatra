...
router.post("/", subscriptionMiddleware, createResume);
router.get("/", subscriptionMiddleware, listResumes);
router.get("/:id", getResume);
router.patch("/:id/rename", renameResume);
router.put("/:id", subscriptionMiddleware, updateResume);
router.delete("/:id", subscriptionMiddleware, deleteResume);

// Upload and parse original resume file
router.post("/upload", subscriptionMiddleware, uploadMiddleware, uploadResume);
...
router.post("/:id/mark-downloaded", markDownloaded);
