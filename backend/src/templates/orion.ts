    ...
    <aside class="sidebar">
      ...
      ${
        ...
        (Array.isArray(data.skills)
          ? data.skills.filter(
              (s: any) => s && (typeof s === "string" ? s.trim() : s)
            ).length > 0
          : (data.skills || "").split(",").filter((s: string) => s.trim())
              .length > 0)
          ? `
      <div class="sidebar-section" style="margin-top: 40px;" data-section="skills">
        ...
        <div>
          ${(Array.isArray(data.skills)
            ...
            .map(
              (skill: any) => `
            <div class="skill-tag"><span class="skill-dot">•</span>${
      ...
      <div class="sidebar-section" style="margin-top: 40px;" data-section="languages">
        ...
        <div class="contact-info">
          ${(data.languages || [])
            .map(
              (lang: any) => `
            <div style="margin-bottom: 5px;">${lang.language || lang}${
                lang.level ? ` (${lang.level})` : ""
              }${lang.capability ? ` - ${lang.capability}` : ""}</div>
          `
            )
            .join("")}
        </div>
    ...
    <main class="main-content">
      ...
      <div class="entry" data-section="internships">
        ...
        ${(data.internships || [])
          ...
          <div class="entry">
            ...
            <div class="entry-sub">${item.title || ""}${
      ...
      <div class="entry" data-section="education">
        ...
        ${(data.education || [])
          ...
          <div class="entry">
            ...
            <div class="entry-sub">${edu.degree || ""}${
              edu.field ? ` in ${edu.field}` : ""
            }${edu.cgpa ? ` • CGPA: ${edu.cgpa}` : ""}</div>
      ...
      <div class="entry" data-section="academicProjects">
        ...
        ${(data.academicProjects || [])
          ...
          <div class="entry">
            ...
            ${
              item.technologies
                ? `<div class="entry-desc"><strong>Technologies:</strong> ${item.technologies}</div>`
                : ""
            }
            ${
              item.url
                ? `<div class="entry-desc"><a href="${item.url}" target="_blank" style="color: var(--primary);">View Project</a></div>`
                : ""
            }
          </div>
        `
      ...
      ${
        (Array.isArray(data.tools)
          ? data.tools
          : (data.tools || "").split(",")
        ).filter((t: any) => t && (typeof t === "string" ? t.trim() : t))
          .length > 0
          ? `
      <div class="entry" data-section="tools">
        ...
        <div>
          ${(Array.isArray(data.tools)
            ...
            .map(
              (tool: any) => `
            <span class="skill-tag"><span class="skill-dot">•</span>${
      ...
      <div class="entry" data-section="socialLinks">
        ...
        ${(data.socialLinks || [])
          ...
          <div class="entry" data-index="${index}">
            <div class="entry-desc"><a href="${link.url}" target="_blank">${
              link.urlText || link.url
            }</a></div>
          </div>
        `
          )
      ...
      ${
        data.customSections && data.customSections.length > 0
          ? data.customSections
              .filter(
                (section: any) => section.entries && section.entries.length > 0
              )
              .map(
