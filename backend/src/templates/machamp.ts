    ...
    <div class="left-column">
      ...
      <div class="section" data-section="skills">
        ...
        <ul class="skills-list" data-section="skills">
          ${(Array.isArray(data.skills) ? data.skills : data.skills.split(",")).map((s: any, index: number) =>
      `<li class="skill-item" data-section="skills" data-index="${index}">${typeof s === "string" ? s.trim() : s}</li>`
    ).join("")}
        </ul>
      </div>` : ""}
      ...
      `<li class="skill-item" data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}</li>`
    ).join("")}
        </ul>
      </div>` : ""}
