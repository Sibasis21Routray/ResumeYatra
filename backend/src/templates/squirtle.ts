...
<body>
  <div class="container">
    <div class="sidebar" data-section="personal">
      ...
      ${(data.sectionVisibility?.skills !== false && data.skills && (Array.isArray(data.skills) ? data.skills.filter((skill: any) => skill && (typeof skill === 'string' ? skill.trim() : skill)) : (data.skills || '').split(',').filter((skill: string) => skill.trim())).length > 0) ? `<div class="sidebar-section" data-section="skills">
    ...
    <div class="main-content">
      ...
      ${data.keyAchievements && data.keyAchievements.filter((a: string) => a && a.trim()).length > 0 ? `<div class="main-section" data-section="keyAchievements">
      ...
      ${data.tools && (Array.isArray(data.tools) ? data.tools : (data.tools || '').split('\n')).filter((line: string) => line && line.trim()).length > 0 ? `<div class="main-section" data-section="tools">
