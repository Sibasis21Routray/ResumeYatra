          ...
          <div class="entry" data-section="projects" data-index="${index}">
            ...
            ${
              project.startDate || project.endDate
                ? `<div class="entry-date" data-section="projects" data-index="${index}" style="margin-bottom: 5px;">${
                    project.startDate || ""
                  } ${
                    project.startDate && project.endDate
                      ? `- ${project.endDate}`
            ...
            ${
              project.url
                ? `<div class="entry-content" data-section="projects" data-index="${index}" style="margin-top: 12px;"><a href="${
                    project.url
                  }" target="_blank" style="color: var(--primary-color); font-weight: 600; text-decoration: none;">${
      ...
      ${
        ...
        ${(data.academicProjects || [])
          ...
          <div class="entry" data-section="academicProjects" data-index="${index}">
            ...
            ${
              item.url
                ? `<div class="entry-content" data-section="academicProjects" data-index="${index}" style="margin-top: 8px;"><a href="${item.url}" target="_blank" style="color: var(--primary-color); font-weight: 600; text-decoration: none;">${item.url}</a></div>`
                : ""
            }
          </div>
        `
