    ...
    <div class="main-layout">
      <div class="left-col">
        ...
        <div class="section-box" data-section="experience">
          ...
          ${data.experience
            ...
            <div class="entry-item" data-index="${index}">
              <div class="entry-bold">${exp.title || ""} | ${
                exp.company || ""
              }${exp.domain ? ` | ${exp.domain}` : ""}</div>
              <div class="entry-sub">${exp.startDate || ""} - ${
                exp.endDate || "Present"
        ...
        <div class="section-box" data-section="internships">
          ...
          ${data.internships
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${item.startDate || ""} - ${
                item.endDate || ""
        ...
        <div class="section-box" data-section="education">
          ...
          ${data.education
            ...
            <div class="entry-item" data-index="${index}">
              <div class="entry-bold">${edu.degree || ""}${
                edu.field ? ` in ${edu.field}` : ""
              }</div>
              <div class="entry-sub">${edu.school || ""}${
                edu.cgpa ? ` • CGPA: ${edu.cgpa}` : ""
              } | ${edu.graduationDate || ""}</div>
            </div>
          `
            )
            .join("")}
        ...
        <div class="section-box" data-section="academicProjects">
          ...
          ${data.academicProjects
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${item.duration || ""}${
        ...
        <div class="section-box" data-section="certifications">
          ...
          ${data.certifications
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${cert.issuer || ""} ${
                cert.date ? `• ${cert.date}` : ""
              }</div>
              ${
                cert.description
        ...
        <div class="section-box" data-section="leadershipPositions">
          ...
          ${data.leadershipPositions
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${item.organization || ""} | ${
                item.startDate || ""
              } - ${item.endDate || ""}</div>
              <div class="description-text">${item.description || ""}</div>
            </div>
        ...
        <div class="section-box" data-section="trainingPrograms">
          ...
          ${data.trainingPrograms
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${item.provider || item.organization || ""}${
        ...
        <div class="section-box" data-section="awards">
          ...
          ${data.awards
            ...
            <div class="entry-item" data-index="${index}">
              ...
              <div class="entry-sub">${award.organization || ""} ${
        ...
        ${data.customSections
          ...
          ${
            section.visible !== false
              ? `
          <div class="section-box" data-section="customSections" data-custom-section-id="${
            section.id
          }">
      ...
      <div class="right-col">
        ...
        <div class="section-box" data-section="contact">
          ...
          ${
            data.personal?.dateOfBirth || data.personal?.dob
              ? `<div class="contact-row" data-section="contact"><span class="contact-label">Date of Birth</span>${
                  data.personal?.dateOfBirth || data.personal?.dob
                }</div>`
              : ""
          }
        ...
        <div class="section-box" data-section="personal">
          ...
          ${
            data.personal?.dateOfBirth || data.personal?.dob
              ? `<div class="contact-row" data-section="personal"><span class="contact-label">Date of Birth</span>${
                  data.personal?.dateOfBirth || data.personal?.dob
                }</div>`
              : ""
          }
        ...
        <div class="section-box" data-section="education">
          ...
          ${data.education
            ...
            <div class="entry-item" data-section="education" data-index="${index}">
              <div class="entry-bold" style="font-size: ${baseFontSize}px;" data-section="education" data-field="degree" data-index="${index}">${
                edu.degree || ""
              }</div>
              <div class="entry-sub" data-section="education" data-field="school" data-index="${index}">${
                edu.school || ""
              }</div>
            </div>
          `
        ...
        <div class="section-box" data-section="languages">
          ...
          ${data.languages
            ...
            <div class="entry-item" data-index="${index}">
              <div class="entry-bold" style="font-size: ${baseFontSize}px;">${
                lang.language || lang
              }</div>
              <div class="entry-sub">${lang.level || ""}${
        ...
        <div class="section-box" data-section="socialLinks">
          ...
          ${data.socialLinks
            ...
            <div class="contact-row" data-index="${index}">
              ...
              <a href="${
                link.url
              }" style="text-decoration:none; color:inherit;">${link.url}</a>
            </div>
          `
            )
            .join("")}
