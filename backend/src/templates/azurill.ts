export function buildAzurillTemplate(data: any, theme?: any): string {
  ...
  // Profile image - using same pattern as Nebula template
  const profileImage = personal.image || personal.photo || personal.avatar || personal.profileImage || "";
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Profile container for image and name side by side */
  /* Profile container for image and name side by side */
.profile-container {
  display: flex;
  align-items: center;
