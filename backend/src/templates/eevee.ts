    ...
    ${(data.internships && data.internships.length > 0) ? `<div class="section" data-section="internships">
      ...
      ${(data.internships || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="internships" data-index="${index}">
          <div class="entry-date-col" data-section="internships" data-index="${index}">${item.startDate || ''} - <br/>${item.endDate || ''}</div>
    ...
    ${(data.academicProjects && data.academicProjects.length > 0) ? `<div class="section" data-section="academicProjects">
      ...
      ${(data.academicProjects || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="academicProjects" data-index="${index}">
          <div class="entry-date-col" data-section="academicProjects" data-index="${index}">${item.duration || ''}</div>
    ...
    ${(data.leadershipPositions && data.leadershipPositions.length > 0) ? `<div class="section" data-section="leadershipPositions">
      ...
      ${(data.leadershipPositions || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="leadershipPositions" data-index="${index}">
          <div class="entry-date-col" data-section="leadershipPositions" data-index="${index}">${item.startDate || ''} - <br/>${item.endDate || ''}</div>
    ...
    ${(data.trainingPrograms && data.trainingPrograms.length > 0) ? `<div class="section" data-section="trainingPrograms">
      ...
      ${(data.trainingPrograms || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="trainingPrograms" data-index="${index}">
          <div class="entry-date-col" data-section="trainingPrograms" data-index="${index}">${item.completionDate || ''}</div>
    ...
    ${(data.scholarships && data.scholarships.length > 0) ? `<div class="section" data-section="scholarships">
      ...
      ${(data.scholarships || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="scholarships" data-index="${index}">
          <div class="entry-date-col" data-section="scholarships" data-index="${index}">${item.year || ''}</div>
    ...
    ${(data.coCurricular && data.coCurricular.length > 0) ? `<div class="section" data-section="coCurricular">
      ...
      ${(data.coCurricular || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="coCurricular" data-index="${index}">
          <div class="entry-date-col" data-section="coCurricular" data-index="${index}">${item.year || (item.startDate ? `${item.startDate} - ${item.endDate || ''}` : '')}</div>
    ...
    ${(data.extracurricular && data.extracurricular.length > 0) ? `<div class="section" data-section="extracurricular">
      ...
      ${(data.extracurricular || []).map((item: any, index: number) => `
        <div class="entry-grid" data-section="extracurricular" data-index="${index}">
          <div class="entry-date-col" data-section="extracurricular" data-index="${index}">${item.year || (item.startDate ? `${item.startDate} - ${item.endDate || ''}` : '')}</div>
