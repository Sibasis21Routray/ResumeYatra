            ...
            <div class="timeline">
              ${data.experience
                ...
                <div class="timeline-item" data-section="experience" data-index="${i}">
                  ...
                  <div class="exp-meta">${exp.company}${
            ...
            <div class="timeline">
              ${data.internships
                ...
                <div class="timeline-item" data-section="internships" data-index="${i}">
                  ...
                  <div class="exp-meta">${item.company}${
            ...
            <div class="timeline">
              ${data.education
                ...
                <div class="timeline-item" data-section="education" data-index="${i}">
                  <div class="exp-title">${edu.degree}${
                    edu.field ? ` in ${edu.field}` : ""
                  }</div>
                  <div class="exp-meta">${edu.school}${
            ...
            <div class="timeline">
              ${data.academicProjects
                ...
                <div class="timeline-item" data-section="academicProjects" data-index="${i}">
                  ...
                  <div class="exp-meta">${item.duration || ""}${
            ...
            <div class="timeline">
              ${data.projects
                ...
                <div class="timeline-item" data-section="projects" data-index="${i}">
                  <div class="exp-title">${project.name}${
                    project.technologies ? ` | ${project.technologies}` : ""
                  }</div>
                  <div class="exp-meta">${project.startDate} – ${
            ...
            <div class="timeline">
              ${data.leadershipPositions
                ...
                <div class="timeline-item" data-section="leadershipPositions" data-index="${i}">
                  ...
                  <div class="exp-meta">${item.organization || ""} • ${
                    item.startDate || ""
                  } – ${item.endDate || ""}</div>
                  <div class="text">${item.description || ""}</div>
                </div>
            ...
            <div class="timeline">
              ${data.trainingPrograms
                ...
                <div class="timeline-item" data-section="trainingPrograms" data-index="${i}">
                  ...
                  <div class="exp-meta">${item.provider || item.organization || ""}${
            ...
            <div class="timeline">
              ${data.awards
                ...
                <div class="timeline-item" data-section="awards" data-index="${i}">
                  ...
                  <div class="exp-meta">${award.organization} • ${
                    award.issueYear
                  }</div>
                  ${
                    award.description
    ...
    ${
      data.customSections && data.customSections.length > 0
        ...
        <div class="section" data-section="customSections">
          <div class="section-title"><i class="fa-solid fa-star"></i>${
