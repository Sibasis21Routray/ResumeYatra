    ...
    <div class="header-contact-bar" data-section="personal">
      ...
      ${
        ...
        data.personal?.fullAddress
          ? `<span class="contact-item" data-section="personal">${
              icons.location
            }${[
              data.personal?.location,
              data.personal?.country,
      ...
      ${
        ...
        ${(data.projects || [])
          ...
          <div class="entry" data-section="projects" data-index="${index}">
            ...
            ${
              project.url
                ? `<div class="entry-content" data-section="projects" data-index="${index}" style="margin-top: 5px;">${
                    icons.link
                  }<a href="${project.url}" target="_blank" style="color: ${
          ...
          ${(Array.isArray(data.skills)
            ...
            .map(
              (skill: any, index: number) =>
                `<div class="skill-tag" data-section="skills" data-index="${index}">${
          ...
          ${(data.languages || [])
            .map(
              (lang: any, index: number) =>
                `<div class="skill-tag" data-section="languages" data-index="${index}">${
                  lang.language || lang
          ...
          ${(data.hobbies || [])
            .map(
              (hobby: any, index: number) =>
                `<div class="skill-tag" data-section="hobbies" data-index="${index}">${hobby}</div>`
            )
            .join("")}
        </div>
      </div>`
        ...
        ${(data.academicProjects || [])
          ...
          <div class="entry" data-section="academicProjects" data-index="${index}">
            <div class="entry-header" data-section="academicProjects" data-index="${index}">
              ...
              item.name || item.title || "Project Name"
            }</div>
