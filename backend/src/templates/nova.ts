export function buildNovaTemplate(data: any, theme?: any): string {
  ...
  const userFontFamily =
    data.formatting?.fontFamily || data.fontFamily || "Poppins  sans-serif";
  ...
  <div class="container">
    ...
    <header class="header" data-section="personal">
      <div class="name-block">
        <div class="name">${
          data.personal?.name?.split(" ").join("<br>") || "YOUR NAME"
        }</div>
      ...
      <div class="photo-container">
        ${
          data.personal?.image
            ...
            : `<div style="display:flex; height:100%; align-items:center; justify-content:center; background:var(--primary); color:white; font-size:40px;">${data.personal?.name?.charAt(
                0
              )}</div>`
        }
      </div>
      ...
      <div class="left-col">
        ...
        <div class="section" data-section="experience">
          ...
          ${data.experience
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${exp.company || ""}${
                exp.domain ? ` | ${exp.domain}` : ""
              }${exp.location ? `, ${exp.location}` : ""} | ${
                exp.startDate || ""
              } - ${exp.endDate || "Present"}</span>
        ...
        <div class="section" data-section="internships">
          ...
          ${data.internships
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${item.company || ""}${
        ...
        <div class="section" data-section="education">
          ...
          ${data.education
            ...
            <div class="entry" data-index="${index}">
              <div class="entry-header">${edu.degree || ""}${
                edu.field ? ` in ${edu.field}` : ""
              }</div>
              <span class="entry-sub">${edu.school || ""} • ${
                edu.graduationDate || ""
              }</span>
        ...
        <div class="section" data-section="academicProjects">
          ...
          ${data.academicProjects
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${item.duration || ""}${
              ...
              ${(Array.isArray(data.skills)
                ...
                .map(
                  (skill: string, index: number) =>
                    `<li data-section="skills" data-index="${index}">${skill.trim()}</li>`
                )
                .join("")}
            </ul>
          </div>
        ...
        <div class="section" data-section="languages">
          ...
          ${data.languages
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${lang.level ? `${lang.level}` : ""}${
        ...
        <div class="section" data-section="certifications">
          ...
          ${data.certifications
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${cert.issuer || ""} ${
                cert.date ? `• ${cert.date}` : ""
              }</span>
              ${
                cert.description
        ...
        <div class="section" data-section="leadershipPositions">
          ...
          ${data.leadershipPositions
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${item.organization || ""} | ${
                item.startDate || ""
              } - ${item.endDate || ""}</span>
              <div class="entry-content">${item.description || ""}</div>
            </div>
        ...
        <div class="section" data-section="awards">
          ...
          ${data.awards
            ...
            <div class="entry" data-index="${index}">
              ...
              <span class="entry-sub">${award.organization || ""} ${
                award.issueYear ? `• ${award.issueYear}` : ""
              }</span>
              ${
                award.description
        ...
        <div class="section" data-section="education">
          ...
          ${data.education
            ...
            <div class="entry" data-section="education" data-index="${index}">
              <div class="entry-header" style="font-size: ${
                baseFontSize - 1
              }px;" data-section="education" data-field="degree" data-index="${index}">${
                edu.degree || ""
              }${edu.field ? ` in ${edu.field}` : ""}</div>
              <span class="entry-sub" style="font-size: ${
                baseFontSize - 2
              }px;" data-section="education" data-field="school" data-index="${index}">${
                edu.school || ""
              }${edu.cgpa ? ` • CGPA: ${edu.cgpa}` : ""}</span>
              <span class="entry-sub" style="font-size: ${
                baseFontSize - 2
              }px;">${edu.graduationDate || ""}</span>
            </div>
          `
            )
            .join("")}
        ...
        <div class="section" data-section="socialLinks">
          ...
          ${data.socialLinks
            ...
            <div class="info-item" data-index="${index}">
              ...
              <div class="info-value"><a href="${link.url}" target="_blank">${
                link.url
              }</a></div>
            </div>
          `
        ...
        ${data.customSections
          ...
          ${
            section.visible !== false
              ? `
          <div class="section" data-section="customSections" data-custom-section-id="${
            section.id
          }">
