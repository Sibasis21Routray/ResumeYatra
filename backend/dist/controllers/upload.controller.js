...
const uploadResume = async (req, res) => {
    ...
    try {
        ...
        console.log(`Processing file: ${req.file.originalname} (ext: ${ext})`);
        ...
        const parsedResume = await (0, resume_parser_dispatcher_1.default)(ownerId, tempFilePath, guestId);
        ...
        if (ownerId) {
            newResume.ownerId = new mongoose_1.default.Types.ObjectId(ownerId);
        }
        else if (guestId) {
        ...
        const initialVersion = new ResumeVersion_1.default({
            resumeId: newResume._id,
            data: parsedResume || {}, // Ensure we have at least an empty object
            version: 1,
            changes: "Initial upload from file",
            createdBy: ownerId ? new mongoose_1.default.Types.ObjectId(ownerId) : undefined,
        });
