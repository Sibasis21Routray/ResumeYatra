    ...
    <div class="sidebar">
      ...
      <div class="sidebar-section">
        ...
        <div class="contact-item" data-field="githubUrl">
          ...
          <a href="${data.personal.githubUrl}" target="_blank">${data.personal.githubUrl
            .replace("https://", "")
            .replace("http://", "")
            .substring(0, 20)}...</a>
        </div>`
        ...
        <div class="contact-item" data-field="website">
          ...
          <a href="${data.personal.portfolioUrl || data.personal.website}" target="_blank">${(data.personal.portfolioUrl || data.personal.website || "")
            .replace("https://", "")
            .replace("http://", "")
            .substring(0, 20)}...</a>
        </div>`
      ...
      <div class="content-section" data-section="education">
        ...
        ${(data.education || [])
          ...
          <div class="item" data-section="education" data-index="${index}">
            <div class="item-title" data-section="education">${edu.degree || ""}${edu.field ? ` in ${edu.field}` : ""}${edu.qualification ? ` (${edu.qualification})` : ""}</div>
            <div class="item-subtitle" data-section="education">${edu.school || ""}${edu.location ? `, ${edu.location}` : ""}</div>
