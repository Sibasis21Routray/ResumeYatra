    ...
    <div class="profile-photo-container">
      ${data.personal?.image
        ? `<img src="${data.personal.image}" alt="${data.personal?.name && data.personal?.name !== "undefined"
            ? data.personal.name
            : "Profile Photo"}" class="profile-photo" />`
    ...
    <div class="left-column">
      ...
      <div class="section" data-section="skills">
        ...
        <ul class="skills-list" data-section="skills">
          ${(Array.isArray(data.skills) ? data.skills : data.skills.split(","))
            .filter((s) => s && (typeof s === "string" ? s.trim() : s))
            .map((s) => `<li class="skill-item">${typeof s === "string" ? s.trim() : s}</li>`)
            .join("")}
        </ul>
      </div>`
        : ""}
      ...
      <div class="section" data-section="languages">
        ...
        <ul class="skills-list" data-section="languages">
          ${(data.languages || [])
            .map((lang) => `<li class="skill-item">${lang.language || lang}${lang.level ? ` (${lang.level})` : ""}</li>`)
            .join("")}
        </ul>
      </div>`
        : ""}
    ...
    <div class="right-column">
      ...
      <div class="section" data-section="experience">
        ...
        ${data.experience
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${exp.company}${exp.location ? `, ${exp.location}` : ""} • ${exp.startDate} - ${exp.endDate || "Present"}</div>
      ...
      <div class="section" data-section="internships">
        ...
        ${data.internships
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${item.company || ""}${item.location ? `, ${item.location}` : ""} • ${item.startDate || ""} - ${item.endDate || ""}</div>
      ...
      <div class="section" data-section="projects">
        ...
        ${data.projects
            ...
            const technologies = typeof project === "string" ? "" : project.technologies || "";
            const startDate = typeof project === "string" ? "" : project.startDate || "";
            const endDate = typeof project === "string" ? "" : project.endDate || "";
            const url = typeof project === "string" ? "" : project.url || "";
            const urlText = typeof project === "string"
                ? ""
          ...
          <div class="entry" data-index="${index}">
            ...
            ${startDate || endDate
                ? `<div class="entry-subtitle">${startDate} ${startDate && endDate ? "- " : ""}${endDate}</div>`
                : ""}
            ${technologies
      ...
      <div class="section" data-section="academicProjects">
        ...
        ${data.academicProjects
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${item.duration || ""}${item.institution ? ` • ${item.institution}` : ""}</div>
            <div class="entry-content">${item.description || ""}</div>
            ${item.technologies
      ...
      <div class="section" data-section="leadershipPositions">
        ...
        ${data.leadershipPositions
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${item.organization || ""} • ${item.startDate || ""} - ${item.endDate || ""}</div>
            <div class="entry-content">${item.description || ""}</div>
          </div>
        `)
            .join("")}
      ...
      <div class="section" data-section="trainingPrograms">
        ...
        ${data.trainingPrograms
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${item.provider || item.organization || ""} • ${item.completionDate || ""}${item.duration ? ` • ${item.duration}` : ""}</div>
            <div class="entry-content">${item.description || ""}</div>
          </div>
        `)
            .join("")}
      ...
      <div class="section" data-section="scholarships">
        ...
        ${data.scholarships
          ...
          <div class="entry" data-index="${index}">
            <div class="entry-title">${item.name || ""}</div>
            <div class="entry-subtitle">${item.provider || item.organization || ""} • ${item.year || ""}${item.amount ? ` • ${item.amount}` : ""}</div>
            <div class="entry-content">${item.description || ""}</div>
          </div>
        `)
            .join("")}
      ...
      <div class="section" data-section="coCurricular">
        ...
        ${data.coCurricular
          ...
          <div class="entry" data-index="${index}">
            ...
            <div class="entry-subtitle">${item.organization || ""}${item.role ? ` • ${item.role}` : ""} • ${item.year ||
          ...
          <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-top: 15px;">
            ${section.entries && section.entries.length > 0
              ...
              <div style="display: flex; align-items: center; gap: 8px;" data-section="socialLinks" data-index="${entryIndex}">
                ...
                <a href="${entry.organization || entry.description || "#"}" target="_blank" style="color: var(--primary-color); text-decoration: none; font-weight: 500; font-size: ${baseFontSize}px;">${(entry.organization ||
                        entry.description ||
                        "")
                        .replace("https://", "")
                        .replace("http://", "")}</a>
          ...
          <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-top: 15px;">
            ${section.entries && section.entries.length > 0
                    ? section.entries
                        .filter((entry) => entry.isVisible)
                        .map((entry, entryIndex) => `
              <div style="background: #f1f5f9; color: #475569; padding: 6px 12px; border-radius: 4px; font-size: 12px; font-weight: 500;" data-section="customSections" data-index="${entryIndex}">${entry.title ||
                        entry.organization ||
                        entry.description ||
                        "Hobby"}</div>
            `)
          ...
          <div class="entry-content">
            <ul>
              ${section.entries && section.entries.length > 0
                    ? section.entries
                        .filter((entry) => entry.isVisible)
                        .map((entry, entryIndex) => `<li data-section="customSections" data-index="${entryIndex}">${entry.title ||
                        entry.organization ||
                        entry.description ||
                        "Achievement"}</li>`)
                        .join("")
