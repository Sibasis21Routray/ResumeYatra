...
exports.buildSeniorLeadershipTemplate = buildSeniorLeadershipTemplate;
function buildSeniorLeadershipTemplate(data, theme) {
      ...
      <div class="resume-body">
        <div class="left-col">
          ...
          <section class="section" data-section="certifications">
            ...
            <ul class="side-list">
              ${nonEmptyCertifications.map((cert, idx) => `<li data-index="${idx}">${cert.name || ''}${cert.issuer ? ` - ${cert.issuer}` : ''}</li>`).join('')}
            </ul>
          </section>
          ` : ''}
          ...
          <section class="section" data-section="education">
            ...
            ${nonEmptyEducation.map((edu, idx) => `<div class="edu-item" data-index="${idx}">
          ...
          <section class="section" data-section="hobbies">
            ...
            <ul class="side-list">
              ${nonEmptyHobbies.map((hobby, idx) => `<li data-index="${idx}">${typeof hobby === "string" ? hobby : hobby}</li>`).join('')}
            </ul>
          </section>
          ` : ''}
          ...
          <section class="section" data-section="socialProfiles">
            ...
            <ul class="side-list">
              ${nonEmptySocialProfiles.map((item, idx) => `<li data-index="${idx}"><a href="${item.url}" style="color: #000; text-decoration: none;">${item.platform || 'Profile'}</a></li>`).join('')}
            </ul>
          </section>
          ` : ''}
        </div>
        ...
        <div class="right-col">
          ...
          <section class="section" data-section="experience">
            ...
            ${nonEmptyExperience.map((exp, idx) => `<div class="exp-item" data-index="${idx}">
          ...
          <section class="section" data-section="projects">
            ...
            ${nonEmptyProjects.map((project, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="internships">
            ...
            ${nonEmptyInternships.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="academicProjects">
            ...
            ${nonEmptyAcademicProjects.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="trainingPrograms">
            ...
            ${nonEmptyTrainingPrograms.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="leadershipPositions">
            ...
            ${nonEmptyLeadershipPositions.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="coCurricular">
            ...
            ${nonEmptyCoCurricular.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="extracurricular">
            ...
            ${nonEmptyExtracurricular.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.activity || ''}</span>
                </div>
                <span class="job-title">${item.role ? `Role: ${item.role}` : ''}${item.year ? ` | ${item.year}` : ''}</span>
          ...
          <section class="section" data-section="scholarships">
            ...
            ${nonEmptyScholarships.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.name || ''}</span>
          ...
          <section class="section" data-section="awards">
            ...
            ${nonEmptyAwards.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="speakingEngagements">
            ...
            ${nonEmptySpeakingEngagements.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="memberships">
            ...
            ${nonEmptyMemberships.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="workshops">
            ...
            ${nonEmptyWorkshops.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="clientProjects">
            ...
            ${nonEmptyClientProjects.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.name || ''}</span>
                </div>
          ...
          <section class="section" data-section="portfolio">
            ...
            ${nonEmptyPortfolio.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.name || ''}</span>
                </div>
          ...
          <section class="section" data-section="volunteering">
            ...
            ${nonEmptyVolunteering.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="militaryService">
            ...
            ${nonEmptyMilitaryService.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="methodologies">
            ...
            ${nonEmptyMethodologies.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.name || ''}</span>
                </div>
          ...
          <section class="section" data-section="industryExpertise">
            ...
            ${nonEmptyIndustryExpertise.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="teachingExperience">
            ...
            ${nonEmptyTeachingExperience.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="mentorshipExperience">
            ...
            ${nonEmptyMentorshipExperience.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="researchGrants">
            ...
            ${nonEmptyResearchGrants.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.title || ''}</span>
                  <span class="date-pill">${item.year || ''}</span>
                </div>
          ...
          <section class="section" data-section="testScores">
            ...
            ${nonEmptyTestScores.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
          ...
          <section class="section" data-section="publications">
            ...
            ${nonEmptyPublications.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.title || ''}</span>
                  <span class="date-pill">${item.year || ''}</span>
                </div>
          ...
          <section class="section" data-section="patents">
            ...
            ${nonEmptyPatents.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.title || ''}</span>
                  <span class="date-pill">${item.year || ''}</span>
                </div>
          ...
          <section class="section" data-section="references">
            ...
            ${nonEmptyReferences.map((item, idx) => `<div class="exp-item" data-index="${idx}">
                <div class="exp-header">
                  <span class="company-name">${item.name || ''}</span>
                </div>
