...
exports.buildModernCorporateTemplate = buildModernCorporateTemplate;
function buildModernCorporateTemplate(data, theme) {
      ...
      <div class="main-content">
        ...
        <div class="left-col">
          ...
          <div class="section" data-section="toolsTechnologies">
            ...
            <ul class="skill-list">
              ${nonEmptyToolsTechnologies.map((item, idx) => `<li data-index="${idx}">${item.name || item}${item.proficiency ? ` (${item.proficiency})` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="hobbies">
            ...
            <ul class="skill-list">
              ${nonEmptyHobbies.map((h, idx) => `<li data-index="${idx}">${typeof h === 'string' ? h : h.name || ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
        ...
        <div class="right-col">
          ...
          <div class="section">
            ...
            ${[...nonEmptyCoCurricular, ...nonEmptyExtracurricular].map((item) => `
              <div class="exp-item">
