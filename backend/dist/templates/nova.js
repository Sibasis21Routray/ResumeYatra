...
function buildNovaTemplate(data, theme) {
    ...
    const nonEmptyResponsibilities = getNonEmptyItems(Array.isArray(data.responsibilities)
        ? data.responsibilities
        : (data.responsibilities || "").split("\n"));
    const nonEmptyTools = getNonEmptyItems(Array.isArray(data.tools) ? data.tools : (data.tools || "").split(","));
  ...
  <div class="container">
    ...
    <header class="header" data-section="personal">
      <div class="name-block">
        <div class="name">${data.personal?.name?.toUpperCase() || "YOUR NAME"}</div>
      ...
      <div class="left-col">
        ...
        ${data.education && hasNonEmptyItems(data.education) ? `
          <div class="section" data-section="education">
            ...
            ${data.education.filter((edu) => edu.degree || edu.school).map((edu, index) => `
              <div class="entry" data-index="${index}">
                <div class="entry-header">
        ...
        ? data.skills
        : `<ul>
                    ${skillsArray.map((skill, index) => `<li data-section="skills" data-index="${index}">${skill}</li>`).join("")}
                  </ul>`}
            </div>
          </div>
        ` : ""}
