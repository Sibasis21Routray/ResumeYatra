        ...
        <div class="section" data-section="internships">
          ...
          ${nonEmptyInternships
            ...
            <div class="entry" data-section="internships" data-index="${index}">
              ...
              <div class="entry-subtitle" data-section="internships" data-index="${index}">${item.company || ""}</div>
          ...
          ${(data.education || [])
            ...
            <div class="entry" data-section="education" data-index="${index}">
              <div class="entry-header" data-section="education" data-index="${index}">
                ...
                <div class="entry-date" data-section="education" data-index="${index}">${edu.startDate || edu.graduationDate
        ...
        <div class="section" data-section="militaryService">
          ...
          ${nonEmptyMilitaryService
            ...
            <div class="entry" data-section="militaryService" data-index="${index}">
              ...
              <div class="entry-subtitle" data-section="militaryService" data-index="${index}">${item.specialization || ""}</div>
          ...
          ${nonEmptyTeachingExperience
            ...
            <div class="entry" data-section="teachingExperience" data-index="${index}">
              <div class="entry-header" data-section="teachingExperience" data-index="${index}">
                <div class="entry-title" data-section="teachingExperience" data-index="${index}">${item.title || ""}</div>
          ...
          ${nonEmptyAwards
            ...
            <div class="entry" data-section="awards" data-index="${index}">
              <div class="entry-header" data-section="awards" data-index="${index}">
                ...
                <div class="entry-date" data-section="awards" data-index="${index}">${item.issueYear || ""}</div>
              </div>
              <div class="entry-subtitle" data-section="awards" data-index="${index}">${item.organization || ""}</div>
              <div class="entry-content" data-section="awards" data-index="${index}">${item.description || ""}</div>
            </div>
          `)
            .join("")}
        </div>
        ...
        <div class="section" data-section="speakingEngagements">
          ...
          ${nonEmptySpeakingEngagements
            ...
            <div class="entry" data-section="speakingEngagements" data-index="${index}">
              ...
              <div class="entry-content" data-section="speakingEngagements" data-index="${index}">${item.description || ""}</div>
            </div>
          `)
            .join("")}
        </div>
        ...
        <div class="section" data-section="memberships">
          ...
          ${nonEmptyMemberships
            ...
            <div class="entry" data-section="memberships" data-index="${index}">
              ...
              <div class="entry-content" data-section="memberships" data-index="${index}">${item.description || ""}</div>
            </div>
          `)
            .join("")}
        </div>
        ...
        <div class="section" data-section="workshops">
          ...
          ${nonEmptyWorkshops
            ...
            <div class="entry" data-section="workshops" data-index="${index}">
              ...
              <div class="entry-content" data-section="workshops" data-index="${index}">${item.description || ""}</div>
            </div>
          `)
            .join("")}
        </div>
          ...
          ${section.entries && section.entries.length > 0
            ...
            <div class="entry" data-section="custom-${sectionIndex}" data-index="${entryIndex}">
              <div class="entry-header" data-section="custom-${sectionIndex}" data-index="${entryIndex}">
                <div class="entry-title" data-section="custom-${sectionIndex}" data-index="${entryIndex}">${entry.title || ""}${entry.title && entry.organization ? " at " : ""}${entry.organization || ""}</div>
                ${entry.date
