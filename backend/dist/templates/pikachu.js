...
exports.buildPikachuTemplate = buildPikachuTemplate;
function buildPikachuTemplate(data, theme) {
    const defaultTheme = {
        primary: '#000000',
        secondary: '#000000',
        background: '#ffffff',
    ...
    const parseSkills = () => {
        ...
        if (Array.isArray(data.skills))
            return data.skills.filter((s) => s && (typeof s === "string" ? s.trim() : s));
...
<div class="container">
    ...
    <div class="personal-info">
      ...
      <div class="contact-info">
        ...
        if (data.personal?.linkedinUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.linkedinUrl}" target="_blank" style="color: #000; text-decoration: underline;">🔗 LinkedIn</a></div>`);
        if (data.personal?.githubUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.githubUrl}" target="_blank" style="color: #000; text-decoration: underline;">🐙 GitHub</a></div>`);
        if (data.personal?.portfolioUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.portfolioUrl}" target="_blank" style="color: #000; text-decoration: underline;">💼 Portfolio</a></div>`);
        if (data.personal?.website)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.website}" target="_blank" style="color: #000; text-decoration: underline;">🌐 Website</a></div>`);
        if (data.personal?.twitterUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.twitterUrl}" target="_blank" style="color: #000; text-decoration: underline;">🐦 Twitter</a></div>`);
        if (data.personal?.facebookUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.facebookUrl}" target="_blank" style="color: #000; text-decoration: underline;">📘 Facebook</a></div>`);
        if (data.personal?.instagramUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.instagramUrl}" target="_blank" style="color: #000; text-decoration: underline;">📷 Instagram</a></div>`);
        if (data.personal?.behanceUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.behanceUrl}" target="_blank" style="color: #000; text-decoration: underline;">🎨 Behance</a></div>`);
        if (data.personal?.dribbbleUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.dribbbleUrl}" target="_blank" style="color: #000; text-decoration: underline;">🏀 Dribbble</a></div>`);
        if (data.personal?.stackoverflowUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.stackoverflowUrl}" target="_blank" style="color: #000; text-decoration: underline;">📚 Stack Overflow</a></div>`);
        if (data.personal?.mediumUrl)
            socialLinks.push(`<div class="contact-item"><a href="${data.personal.mediumUrl}" target="_blank" style="color: #000; text-decoration: underline;">📝 Medium</a></div>`);
        ...
        if (data.personal?.fathersName)
            personalDetails.push(`<div class="contact-item">👨 Father: ${data.personal.fathersName}</div>`);
        if (data.personal?.dob)
            personalDetails.push(`<div class="contact-item">📅 DOB: ${data.personal.dob}</div>`);
        if (data.personal?.gender)
            personalDetails.push(`<div class="contact-item">⚥ Gender: ${data.personal.gender}</div>`);
        if (data.personal?.maritalStatus)
            personalDetails.push(`<div class="contact-item">💍 Marital: ${data.personal.maritalStatus}</div>`);
        if (data.personal?.nationality)
            personalDetails.push(`<div class="contact-item">🌍 Nationality: ${data.personal.nationality}</div>`);
        if (data.personal?.passportNo)
            personalDetails.push(`<div class="contact-item">🛂 Passport: ${data.personal.passportNo}</div>`);
  ...
  <div class="content-wrapper">
      ...
      <div class="section" data-section="experience">
        ...
        <div class="horizontal-line"></div>
        ${getNonEmptyArray(data.experience).map((exp, index) => {
      ...
      <div class="section" data-section="internships">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyInternships.map((item, index) => {
      ...
      <div class="section" data-section="trainingPrograms">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyTrainingPrograms.map((item, index) => `
      ...
      <div class="section" data-section="education">
        ...
        <div class="horizontal-line"></div>
        ${getNonEmptyArray(data.education).map((edu, index) => `
      ...
      <div class="section" data-section="academicProjects">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyAcademicProjects.map((item, index) => `
      ...
      <div class="section" data-section="clientProjects">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyClientProjects.map((item, index) => `
      ...
      <div class="section" data-section="portfolio">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyPortfolio.map((item, index) => `
      ...
      <div class="section" data-section="leadershipPositions">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyLeadershipPositions.map((item, index) => {
      ...
      <div class="section" data-section="volunteering">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyVolunteering.map((item, index) => `
      ...
      <div class="section" data-section="militaryService">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyMilitaryService.map((item, index) => `
      ...
      <div class="section" data-section="teachingExperience">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyTeachingExperience.map((item, index) => `
      ...
      <div class="section" data-section="mentorshipExperience">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyMentorshipExperience.map((item, index) => `
      ...
      <div class="section" data-section="researchGrants">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyResearchGrants.map((item, index) => `
      ...
      <div class="section" data-section="publications">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyPublications.map((item, index) => `
      ...
      <div class="section" data-section="patents">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyPatents.map((item, index) => `
      ...
      <div class="section" data-section="testScores">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyTestScores.map((item, index) => `
      ...
      <div class="section" data-section="scholarships">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyScholarships.map((item, index) => `
      ...
      <div class="section" data-section="coCurricular">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyCoCurricular.map((item, index) => `
      ...
      <div class="section" data-section="extracurricular">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyExtracurricular.map((item, index) => `
      ...
      <div class="section" data-section="toolsTechnologies">
        ...
        <div class="horizontal-line"></div>
        <div class="skills-grid">
          ${nonEmptyToolsTechnologies.map((item) => `
      ...
      <div class="section" data-section="methodologies">
        ...
        <div class="horizontal-line"></div>
        <div class="skills-grid">
          ${nonEmptyMethodologies.map((item) => `
      ...
      <div class="section" data-section="industryExpertise">
        ...
        <div class="horizontal-line"></div>
        <div class="skills-grid">
          ${nonEmptyIndustryExpertise.map((item) => `
      ...
      <div class="section" data-section="certifications">
        ...
        <div class="horizontal-line"></div>
        <ul>
          ${nonEmptyCertifications.map((cert) => `<li>${cert.name || ''} - ${cert.issuer || ''} ${cert.date ? `(${cert.date})` : ''}</li>`).join('')}
        </ul>
      ...
      <div class="section" data-section="languages">
        ...
        <div class="horizontal-line"></div>
        <ul>
          ${nonEmptyLanguages.map((lang) => `<li>${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="section" data-section="hobbies">
        ...
        <div class="horizontal-line"></div>
        <div class="tags-container">
          ${nonEmptyHobbies.map((hobby) => `<span class="tag">${hobby}</span>`).join('')}
        </div>
      </div>` : ''}
      ...
      <div class="section" data-section="socialLinks">
        ...
        <div class="horizontal-line"></div>
        <div class="tags-container">
          ${nonEmptySocialLinks.map((link) => `<a href="${link.url}" target="_blank" style="color: #000; text-decoration: underline; margin-right: 15px;">${link.urlText || link.url.replace('https://', '').replace('http://', '')}</a>`).join('')}
        </div>
      </div>` : ''}
      ...
      <div class="section" data-section="socialProfiles">
        ...
        <div class="horizontal-line"></div>
        <div class="tags-container">
          ${nonEmptySocialProfiles.map((profile) => `<a href="${profile.url}" target="_blank" style="color: #000; text-decoration: underline; margin-right: 15px;">${profile.platform || "Profile"}</a>`).join('')}
        </div>
      </div>` : ''}
      ...
      <div class="section" data-section="references">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyReferences.map((ref, index) => `
      ...
      <div class="section" data-section="keyAchievements">
        ...
        <div class="horizontal-line"></div>
        <ul>
          ${nonEmptyKeyAchievements.map((achievement) => `<li>${achievement}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="section" data-section="responsibilities">
        ...
        <div class="horizontal-line"></div>
        <ul>
          ${nonEmptyResponsibilities.map((line) => `<li>${line.trim()}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="section" data-section="tools">
        ...
        <div class="horizontal-line"></div>
        <ul>
          ${nonEmptyTools.map((line) => `<li>${line.trim()}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="section" data-section="awards">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyAwards.map((award, index) => `
      ...
      <div class="section" data-section="speakingEngagements">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptySpeakingEngagements.map((item, index) => `
      ...
      <div class="section" data-section="memberships">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyMemberships.map((item, index) => `
      ...
      <div class="section" data-section="workshops">
        ...
        <div class="horizontal-line"></div>
        ${nonEmptyWorkshops.map((item, index) => `
      ...
      <!-- Custom Sections -->
      ${nonEmptyCustomSections.length > 0 ? data.customSections.filter((section) => section.isVisible && section.entries && hasNonEmptyItems(section.entries)).map((section) => `
        <div class="section" data-section="customSections">
          <span class="section-title">${section.heading || 'Custom Section'}</span>
          <div class="horizontal-line"></div>
          ${section.entries && section.entries.length > 0 ? section.entries.filter((entry) => entry.isVisible && (entry.title || entry.description)).map((entry, entryIndex) => `
