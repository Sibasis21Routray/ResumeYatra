...
function buildBlastoiseTemplate(data, theme) {
    ...
    if (data.personal?.linkedinUrl)
        contactItems.push(`<a href="${data.personal.linkedinUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Linkedin: ${data.personal.linkedinUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.githubUrl)
        contactItems.push(`<a href="${data.personal.githubUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">GitHub: ${data.personal.githubUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.portfolioUrl)
        contactItems.push(`<a href="${data.personal.portfolioUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Portfolio: ${data.personal.portfolioUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.website)
        contactItems.push(`<a href="${data.personal.website}" target="_blank" style="color: ${textColor}; text-decoration: none;">Website: ${data.personal.website
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.twitterUrl)
        contactItems.push(`<a href="${data.personal.twitterUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Twitter: ${data.personal.twitterUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.facebookUrl)
        contactItems.push(`<a href="${data.personal.facebookUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Facebook: ${data.personal.facebookUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.instagramUrl)
        contactItems.push(`<a href="${data.personal.instagramUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Instagram: ${data.personal.instagramUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.behanceUrl)
        contactItems.push(`<a href="${data.personal.behanceUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Behance: ${data.personal.behanceUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.dribbbleUrl)
        contactItems.push(`<a href="${data.personal.dribbbleUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Dribbble: ${data.personal.dribbbleUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.stackoverflowUrl)
        contactItems.push(`<a href="${data.personal.stackoverflowUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Stack Overflow: ${data.personal.stackoverflowUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
    if (data.personal?.mediumUrl)
        contactItems.push(`<a href="${data.personal.mediumUrl}" target="_blank" style="color: ${textColor}; text-decoration: none;">Medium: ${data.personal.mediumUrl
            .replace("https://", "")
            .replace("http://", "")}</a>`);
        ...
        ${data.experience
          ...
          <div class="exp-item" data-section="experience" data-index="${index}">
            ...
            (typeof achievement === "string"
                ? achievement.trim()
                : String(achievement).trim())).length > 0
            ? `
        ...
        ${data.trainingPrograms
          ...
          <div class="exp-item" data-section="trainingPrograms" data-index="${index}">
            <div class="exp-header">
              ...
              <div class="exp-company">${item.provider || item.organization || ""}${item.duration ? ` | ${item.duration}` : ""}</div>
      ...
      <div class="main-section">
        ...
        ${data.scholarships
          ...
          <div class="exp-item" data-section="scholarships" data-index="${index}">
            <div class="exp-header">
              <div class="exp-title">${item.name || ""}</div>
              <div class="exp-company">${item.provider || item.organization || ""}${item.amount ? ` | ${item.amount}` : ""}</div>
        ...
        ${data.coCurricular
          ...
          <div class="exp-item" data-section="coCurricular" data-index="${index}">
            <div class="exp-header">
              ...
              <div class="exp-company">${item.organization || ""}${item.role ? ` | ${item.role}` : ""}</div>
              <div class="exp-date">${item.year ||
            (item.startDate
      ...
      <div class="main-section">
        ...
        ${data.projects
          ...
          <div class="exp-item" data-section="projects" data-index="${index}">
            ...
            : ""}
            ${project.url
            ? `<p class="exp-description"><a href="${project.url}" target="_blank" style="color: ${currentTheme.primary}; text-decoration: underline;">${project.urlText || "View Project"}</a></p>`
            : ""}
          </div>
        `)
            .join("")}
        ...
        <ul class="exp-achievements">
          ${section.entries && section.entries.length > 0
                    ? section.entries
                        ...
                        .map((entry, index) => `
            <li data-section="customSections" data-index="${index}">${entry.language ||
                        entry.title ||
                        entry.organization ||
                        "Language"}${entry.level ? ` (${entry.level})` : ""}</li>
          `)
                        .join("")
            ...
            else if (lowerHeading.includes("hobby") ||
        ...
        <ul class="hobbies-list">
          ${section.entries && section.entries.length > 0
                    ? section.entries
                        .filter((entry) => entry.isVisible)
                        .map((entry, index) => `
            <li class="hobby-item" data-section="customSections" data-index="${index}">${entry.title ||
                        entry.organization ||
                        entry.description ||
                        "Hobby"}</li>
          `)
            ...
            else if (lowerHeading.includes("achievement") ||
        ...
        <ul class="exp-achievements">
          ${section.entries && section.entries.length > 0
                    ? section.entries
                        .filter((entry) => entry.isVisible)
                        .map((entry, index) => `
            <li data-section="customSections" data-index="${index}">${entry.title ||
                        entry.organization ||
                        entry.description ||
                        "Achievement"}</li>
          `)
            ...
            else if (lowerHeading.includes("responsibility") ||
      ...
      <div class="main-section">
        ...
        <ul class="exp-achievements">
          ...
          `)
            ...
            else if (lowerHeading.includes("tool") ||
    ...
    <div class="right-column">
      ...
      ${data.sectionVisibility?.skills !== false &&
        ...
        (Array.isArray(data.skills)
            ? data.skills.filter((skill) => skill && (typeof skill === "string" ? skill.trim() : skill)).length > 0
            : (data.skills || "")
                .split(",")
