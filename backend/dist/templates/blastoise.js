...
function buildBlastoiseTemplate(data, theme) {
    ...
    if (addressParts.length > 0)
        contactItems.push(addressParts.join(", "));
    ...
    if (data.personal?.nationality)
        contactItems.push(`Nationality: ${data.personal.nationality}`);
    if (data.personal?.passportNo)
        contactItems.push(`Passport No: ${data.personal.passportNo}`);
  ...
  <div class="container">
    <div class="left-column">
      ...
      <div class="main-section" data-section="experience">
        ...
        ${getNonEmptyArray(data.experience).map((e, index) => {
          ...
          <div class="exp-item" data-section="experience" data-index="${index}">
            ...
            ${e.achievements ? `
              <ul class="exp-achievements">
                ${(Array.isArray(e.achievements) ? e.achievements : [e.achievements]).map((achievement, achIndex) => `
      ...
      <div class="main-section" data-section="education">
        ...
        ${getNonEmptyArray(data.education).map((e, index) => `
          <div class="exp-item" data-section="education" data-index="${index}">
            ...
            ${e.achievements && e.achievements.length > 0 ? `
              <ul class="exp-achievements">
                ${e.achievements.filter((a) => a.trim()).map((achievement, achIndex) => `
      ...
      <div class="main-section" data-section="keyAchievements">
        ...
        <ul class="exp-achievements">
          ${nonEmptyKeyAchievements.map((achievement, index) => `
      ...
      <div class="main-section" data-section="responsibilities">
        ...
        <ul class="exp-achievements">
          ${nonEmptyResponsibilities.map((line, index) => `
      ...
      <div class="main-section" data-section="socialProfiles">
        ...
        <div class="tags-container">
          ${nonEmptySocialProfiles.map((profile, index) => `
      ...
      ${nonEmptyCustomSections.length > 0 ? data.customSections
        .filter((section) => section.isVisible && section.entries && hasNonEmptyItems(section.entries))
        .map((section) => {
      ...
      <div class="main-section" data-section="customSections">
        ...
        <ul class="exp-achievements">
          ${section.entries && section.entries.length > 0
                ? section.entries.filter((entry) => entry.isVisible && (entry.title || entry.organization || entry.description))
                    .map((entry, index) => `
      ...
      <div class="main-section" data-section="customSections">
        <div class="section-title">${heading}</div>
        ${section.entries && section.entries.length > 0
                ? section.entries.filter((entry) => entry.isVisible && (entry.title || entry.description))
