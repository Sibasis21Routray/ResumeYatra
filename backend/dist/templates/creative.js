  ...
  <div class="container clearfix">
    ...
    <div class="sidebar">
      ...
      ${data.personal?.email ||
        ...
        (data.personal?.personalInfoDisplay === "inline" && (data.personal?.fathersName ||
            data.personal?.dob ||
          ...
          ${data.personal?.personalInfoDisplay === "inline"
            ? (() => {
                ...
                if (data.personal?.fathersName)
                    inlineItems.push(`Father: ${data.personal.fathersName}`);
                if (data.personal?.dob)
                    inlineItems.push(`DOB: ${data.personal.dob}`);
                if (data.personal?.gender)
                    inlineItems.push(`Gender: ${data.personal.gender}`);
                if (data.personal?.maritalStatus)
                    inlineItems.push(`Marital: ${data.personal.maritalStatus}`);
                if (data.personal?.nationality)
                    inlineItems.push(`Nationality: ${data.personal.nationality}`);
    ...
    <div class="main-content">
      ...
      ${data.sectionVisibility?.languages !== false &&
        ...
        <div class="languages-list" data-section="languages">
          ${(data.languages || [])
            .map((lang, index) => `
            <div class="language-item" data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}</div>
          `)
            .join("")}
        </div>
      </div>`
      ...
      ${data.sectionVisibility?.socialLinks !== false &&
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-top: 10px;" data-section="socialLinks">
          ${data.socialLinks
            .map((link, index) => `
            <a href="${link.url}" target="_blank" style="color: #3498db; text-decoration: none; font-weight: 500; font-size: ${baseFontSize}px; border-bottom: 1px dotted #3498db;" data-section="socialLinks" data-index="${index}">${link.urlText ||
      ...
      ${nonEmptyKeyAchievements.length > 0
        ...
        <ul style="list-style: none; padding-left: 0;" data-section="keyAchievements">
          ${nonEmptyKeyAchievements
            .map((achievement, index) => `<li style="margin-bottom: 8px; color: #34495e; position: relative; padding-left: 15px;" data-section="keyAchievements" data-index="${index}">
      ...
      ${nonEmptyResponsibilities.length > 0
        ...
        <ul style="list-style: none; padding-left: 0;" data-section="responsibilities">
          ${nonEmptyResponsibilities
            .map((line, index) => `<li style="margin-bottom: 8px; color: #34495e; position: relative; padding-left: 15px;" data-section="responsibilities" data-index="${index}">
      ...
      ${nonEmptyTools.length > 0
        ...
        <ul style="list-style: none; padding-left: 0;" data-section="tools">
          ${nonEmptyTools
            .map((line, index) => `<li style="margin-bottom: 8px; color: #34495e; position: relative; padding-left: 15px;" data-section="tools" data-index="${index}">
                  <span style="position: absolute; left: 0; color: #3498db;">•</span> ${line.trim()}
                </li>`)
            .join("")}
        </ul>
      ...
      ${data.customSections && data.customSections.length > 0
        ...
        <div class="section" data-section="custom-${sectionIndex}">
          <div class="section-title" data-section="custom-${sectionIndex}">${section.heading || "Custom Section"}</div>
          ${section.entries && section.entries.length > 0
            ...
            <div class="experience-item" data-section="custom-${sectionIndex}" data-index="${entryIndex}">
              <div class="experience-header" data-section="custom-${sectionIndex}" data-index="${entryIndex}">
                ...
                ? `<div class="experience-title" data-section="custom-${sectionIndex}" data-index="${entryIndex}">${entry.title || ""}${entry.title && entry.organization ? " at " : ""}${entry.organization || ""}</div>`
                : ""}
                </div>
                ${entry.date
