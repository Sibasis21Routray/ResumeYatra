        ...
        ${(data.projects || [])
          ...
          <div class="entry" data-section="projects" data-index="${index}">
            ...
            <div class="entry-content-col" data-section="projects" data-index="${index}">
              ...
              ${project.url
            ? `<div class="entry-description" data-section="projects" data-index="${index}" style="margin-top: 5px;"><a href="${project.url}" target="_blank" style="color: ${currentTheme.primary}; text-decoration: underline;">${project.urlText || "View Project"}</a></div>`
            : ""}
            </div>
          </div>
        `)
        ...
        <div class="skills-section-content" data-section="languages">
          ${(data.languages || [])
            ...
            <div class="skill-item" data-section="languages" data-index="${index}">
               <div class="skill-bullet"></div>
               <div>${lang.language || lang}${lang.level ? ` (${lang.level})` : ""}</div>
            </div>
          `)
            .join("")}
        </div>
