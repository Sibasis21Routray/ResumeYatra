      ...
      <div class="main-section" data-section="internships">
        ...
        ${data.internships.map((item, index) => `
          <div class="exp-item" data-section="internships" data-index="${index}">
            ...
            <ul>
              ${item.description ? (typeof item.description === 'string' ? item.description.split('\n').filter((l) => l.trim()).map((l, lineIndex) => `<li data-section="internships" data-index="${index}" data-item-index="${lineIndex}">${l}</li>`).join('') : `<li data-section="internships" data-index="${index}">${item.description}</li>`) : ''}
            </ul>
          </div>
        `).join('')}
      </div>` : ''}
