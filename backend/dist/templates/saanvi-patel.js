...
function buildSaanviPatelTemplate(data, theme) {
    const { personal = {}, summary = "", careerObjective = "", experience = [], projects = [], education = [], skills = [], languages = [], hobbies = [], certifications = [], awards = [], speakingEngagements = [], memberships = [], workshops = [], socialLinks = [], customSections = [], 
    // Additional sections from your data
    internships = [], trainingPrograms = [], academicProjects = [], leadershipPositions = [], coCurricular = [], extracurricular = [], scholarships = [], clientProjects = [], portfolio = [], volunteering = [], militaryService = [], toolTechnologies = [], methodologies = [], industryExpertise = [], references = [], socialProfiles = [], teachingExperience = [], mentorshipExperience = [], researchGrants = [], testScores = [], publications = [], patents = [], professionalContext = {}, toolsTechnologies = [] } = data;
      ...
      <div class="page-border">
            ...
            ${academicProjects.map((item, index) => `
              <div class="entry" data-section="academicProjects" data-index="${index}">
                ...
                ${item.technologies && item.technologies.length > 0 ? `
                  <div class="entry-detail"><b>Technologies:</b> ${Array.isArray(item.technologies) ? item.technologies.join(", ") : item.technologies}</div>
                ` : ""}
        ...
        ${militaryService.length > 0 ? `
          <div class="section" data-section="militaryService">
            ...
            ${militaryService.map((item, index) => `
        ...
        ${mentorshipExperience.length > 0 ? `
          <div class="section" data-section="mentorshipExperience">
            ...
            ${mentorshipExperience.map((item, index) => `
            ...
            return `
              <div class="section" data-section="skills">
                ...
                <ul class="skills-list">
                  ${skills.map((skill, index) => `<li data-section="skills" data-index="${index}">${skill}</li>`).join("")}
                </ul>
              </div>
            `;
        }
        ...
        ${toolsTechnologies && toolsTechnologies.length > 0 ? `
          <div class="section" data-section="toolsTechnologies">
            ...
            <div class="grid-2">
              ${toolsTechnologies.map((item, index) => `
        ...
        ${methodologies.length > 0 ? `
          <div class="section" data-section="methodologies">
            ...
            <div class="skills-list">
              <ul>
                ${methodologies.map((item, index) => `<li data-section="methodologies" data-index="${index}">${item.name || item}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${industryExpertise.length > 0 ? `
          <div class="section" data-section="industryExpertise">
            ...
            <div class="skills-list">
              <ul>
                ${industryExpertise.map((item, index) => `<li data-section="industryExpertise" data-index="${index}">${item.industry || item}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${languages.length > 0 ? `
          <div class="section" data-section="languages">
            ...
            <div class="skills-list">
              <ul>
                ${languages.map((lang, index) => `<li data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ""}${lang.capability ? ` - ${lang.capability}` : ""}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${hobbies.length > 0 ? `
          <div class="section" data-section="hobbies">
            ...
            <div class="skills-list">
              <ul>
                ${hobbies.map((hobby, index) => `<li data-section="hobbies" data-index="${index}">${hobby.hobby || hobby}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${memberships.length > 0 ? `
          <div class="section" data-section="memberships">
            ...
            <div class="skills-list">
              <ul>
                ${memberships.map((item, index) => `<li data-section="memberships" data-index="${index}">${item.name || item}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${socialLinks.length > 0 ? `
          <div class="section" data-section="socialLinks">
            ...
            <div class="skills-list">
              <ul>
                ${socialLinks.map((item, index) => `<li data-section="socialLinks" data-index="${index}">${item.urlText || item.platform || "Link"}: <a href="${item.url || ""}" target="_blank">${item.url || ""}</a></li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${socialProfiles.length > 0 ? `
          <div class="section" data-section="socialProfiles">
            ...
            <div class="skills-list">
              <ul>
                ${socialProfiles.map((item, index) => `<li data-section="socialProfiles" data-index="${index}">${item.platform || "Profile"}: <a href="${item.url || ""}" target="_blank">${item.url || ""}</a></li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
        ...
        ${references.length > 0 ? `
          <div class="section" data-section="references">
            ...
            <div class="skills-list">
              <ul>
                ${references.map((item, index) => `<li data-section="references" data-index="${index}">${item.name || item}${item.relation ? ` - ${item.relation}` : ""}${item.contact ? ` (${item.contact})` : ""}</li>`).join("")}
              </ul>
            </div>
          </div>
        ` : ""}
