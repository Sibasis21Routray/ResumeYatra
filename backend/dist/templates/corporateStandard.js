...
exports.buildCorporateStandardTemplate = buildCorporateStandardTemplate;
function buildCorporateStandardTemplate(data, theme) {
    ...
    <body>
      ...
      <section class="section" data-section="trainingPrograms">
        ...
        <ul class="simple-list">
          ${nonEmptyTrainingPrograms.map((item, idx) => `<li data-index="${idx}"><strong>${item.name || ''}</strong>${item.provider ? ` - ${item.provider}` : ''}${item.completionDate ? ` (${item.completionDate})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="leadershipPositions">
        ...
        <ul class="simple-list">
          ${nonEmptyLeadershipPositions.map((item, idx) => `<li data-index="${idx}"><strong>${item.position || item.title || ''}</strong>${item.organization ? ` at ${item.organization}` : ''}${formatDateRange(item.startDate, item.endDate) ? ` (${formatDateRange(item.startDate, item.endDate)})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="coCurricular">
        ...
        <ul class="simple-list">
          ${nonEmptyCoCurricular.map((item, idx) => `<li data-index="${idx}"><strong>${item.activity || ''}</strong>${item.role ? ` - ${item.role}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="extracurricular">
        ...
        <ul class="simple-list">
          ${nonEmptyExtracurricular.map((item, idx) => `<li data-index="${idx}"><strong>${item.activity || ''}</strong>${item.role ? ` - ${item.role}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="toolsTechnologies">
        ...
        <ul class="grid-list">
          ${nonEmptyToolsTechnologies.map((item, idx) => `<li data-index="${idx}">${item.name || ''}${item.proficiency ? ` (${item.proficiency})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="methodologies">
        ...
        <ul class="simple-list">
          ${nonEmptyMethodologies.map((item, idx) => `<li data-index="${idx}"><strong>${item.name || ''}</strong>${item.certification ? ` - ${item.certification}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="industryExpertise">
        ...
        <ul class="simple-list">
          ${nonEmptyIndustryExpertise.map((item, idx) => `<li data-index="${idx}"><strong>${item.industry || ''}</strong>${item.domainArea ? ` (${item.domainArea})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="certifications">
        ...
        <ul class="simple-list">
          ${nonEmptyCertifications.map((cert, idx) => `<li data-index="${idx}"><strong>${cert.name || ''}</strong>${cert.issuer ? ` - ${cert.issuer}` : ''}${cert.date ? ` (${cert.date})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="languages">
        ...
        <ul class="grid-list">
          ${nonEmptyLanguages.map((lang, idx) => `<li data-index="${idx}">${lang.language || lang}${lang.proficiency ? ` - ${lang.proficiency}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="scholarships">
        ...
        <ul class="simple-list">
          ${nonEmptyScholarships.map((item, idx) => `<li data-index="${idx}"><strong>${item.name || ''}</strong>${item.provider ? ` - ${item.provider}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="awards">
        ...
        <ul class="simple-list">
          ${nonEmptyAwards.map((item, idx) => `<li data-index="${idx}"><strong>${item.title || ''}</strong>${item.organization ? ` - ${item.organization}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="speakingEngagements">
        ...
        <ul class="simple-list">
          ${nonEmptySpeakingEngagements.map((item, idx) => `<li data-index="${idx}"><strong>${item.topic || ''}</strong>${item.eventName ? ` at ${item.eventName}` : ''}${item.date ? ` (${item.date})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="memberships">
        ...
        <ul class="simple-list">
          ${nonEmptyMemberships.map((item, idx) => `<li data-index="${idx}"><strong>${item.membershipName || ''}</strong>${item.organizationName ? ` - ${item.organizationName}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="workshops">
        ...
        <ul class="simple-list">
          ${nonEmptyWorkshops.map((item, idx) => `<li data-index="${idx}"><strong>${item.programTitle || item.title || ''}</strong>${item.conductedBy ? ` by ${item.conductedBy}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="portfolio">
        ...
        <ul class="simple-list">
          ${nonEmptyPortfolio.map((item, idx) => `<li data-index="${idx}"><strong>${item.name || ''}</strong>${item.url ? ` - <a href="${item.url}" style="color: #000;">${item.url}</a>` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="volunteering">
        ...
        <ul class="simple-list">
          ${nonEmptyVolunteering.map((item, idx) => `<li data-index="${idx}"><strong>${item.role || ''}</strong>${item.organization ? ` at ${item.organization}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="militaryService">
        ...
        <ul class="simple-list">
          ${nonEmptyMilitaryService.map((item, idx) => `<li data-index="${idx}"><strong>${item.branch || ''}</strong>${item.rank ? ` - ${item.rank}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="teachingExperience">
        ...
        <ul class="simple-list">
          ${nonEmptyTeachingExperience.map((item, idx) => `<li data-index="${idx}"><strong>${item.subjectCourseTaught || item.title || ''}</strong>${item.institution ? ` at ${item.institution}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="mentorshipExperience">
        ...
        <ul class="simple-list">
          ${nonEmptyMentorshipExperience.map((item, idx) => `<li data-index="${idx}"><strong>${item.mentorshipArea || ''}</strong>${item.organizationPlatform ? ` at ${item.organizationPlatform}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="researchGrants">
        ...
        <ul class="simple-list">
          ${nonEmptyResearchGrants.map((item, idx) => `<li data-index="${idx}"><strong>${item.title || ''}</strong>${item.agency ? ` - ${item.agency}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="testScores">
        ...
        <ul class="simple-list">
          ${nonEmptyTestScores.map((item, idx) => `<li data-index="${idx}"><strong>${item.testName || ''}</strong> - Score: ${item.score || ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="publications">
        ...
        <ul class="simple-list">
          ${nonEmptyPublications.map((item, idx) => `<li data-index="${idx}"><strong>${item.title || ''}</strong>${item.journalPublisher ? ` - ${item.journalPublisher}` : ''}${item.year ? ` (${item.year})` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="patents">
        ...
        <ul class="simple-list">
          ${nonEmptyPatents.map((item, idx) => `<li data-index="${idx}"><strong>${item.title || ''}</strong>${item.patentNumber ? ` - ${item.patentNumber}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="references">
        ...
        <ul class="simple-list">
          ${nonEmptyReferences.map((item, idx) => `<li data-index="${idx}"><strong>${item.name || ''}</strong>${item.designationRelationship ? ` - ${item.designationRelationship}` : ''}</li>`).join('')}
        </ul>
      </section>` : ''}
      ...
      <section class="section" data-section="socialProfiles">
        ...
        <ul class="social-list">
          ${nonEmptySocialProfiles.map((item, idx) => `<li data-index="${idx}"><strong>${item.platform || 'Profile'}:</strong> <a href="${item.url || ''}" target="_blank">${item.url || ''}</a></li>`).join('')}
        </ul>
      </section>` : ''}
    </body>
    </html>
