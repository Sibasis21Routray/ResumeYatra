  ...
  <div class="header" data-section="personal">
    <div class="header-content">
      <div class="name">${data.personal?.name && data.personal?.name !== "undefined"
        ? data.personal.name
        : "Your Name"}</div>
      <div class="tagline">${data.summary ||
        "Deliver informed health care decisions, generate business, manages claims & services and other administrative functions."}</div>
      ...
      ${sortedExperience.length > 0
        ...
        ${sortedExperience
          ...
          <div class="experience-item" data-index="${index}">
            ...
            <div class="company-info">${exp.company || ""}${exp.company && (exp.startDate || exp.endDate) ? ", " : ""}${exp.location || ""}</div>
            <div class="company-info">${exp.startDate || ""} - ${exp.endDate || "Present"}</div>
            ${exp.description
            ? `<ul>${exp.description
                .split("\n")
      ...
      ${data.internships && data.internships.length > 0
        ...
        ${data.internships
          ...
          <div class="experience-item" data-index="${index}">
            ...
            <div class="company-info">${item.company || ""}${item.location ? `, ${item.location}` : ""}</div>
      ...
      ${data.sectionVisibility?.projects !== false &&
        ...
        ${data.projects
          ...
          <div class="experience-item" data-index="${index}">
            ...
            <div class="company-info">${project.technologies || ""} | ${project.startDate || ""} - ${project.endDate || "Present"}</div>
      ...
      ${data.academicProjects && data.academicProjects.length > 0
        ...
        ${data.academicProjects
          ...
          <div class="experience-item" data-index="${index}">
            ...
            <div class="company-info">${item.institution || ""}${item.duration ? ` | ${item.duration}` : ""}</div>
            <div class="section-content">${item.description || ""}</div>
            ${item.technologies
      ...
      ${data.trainingPrograms && data.trainingPrograms.length > 0
        ...
        ${data.trainingPrograms
          ...
          <div class="experience-item" data-index="${index}">
            ...
            <div class="company-info">${item.completionDate || ""}${item.duration ? ` | ${item.duration}` : ""}</div>
            <div class="section-content">${item.description || ""}</div>
          </div>
        `)
            .join("")}
      ...
      ${data.scholarships && data.scholarships.length > 0
        ...
        ${data.scholarships
          ...
          <div class="experience-item" data-index="${index}">
            <div class="job-title">${item.name || ""}</div>
            <div class="company-info">${item.provider || item.organization || ""}</div>
            <div class="company-info">${item.year || ""}${item.amount ? ` | ${item.amount}` : ""}</div>
            <div class="section-content">${item.description || ""}</div>
          </div>
        `)
            .join("")}
    ...
    <div class="sidebar">
      <div class="section" data-section="contact">
        ...
        ? `<div class="contact-item">
          ...
          ${data.personal.phone}${data.personal?.alternatePhone
      ...
      ${data.sectionVisibility?.education !== false &&
        ...
        ${data.education
          ...
          <div class="training-item" data-index="${index}">
            <div class="training-name">${edu.degree || ""}${edu.qualification ? ` (${edu.qualification})` : ""}</div>
            ${edu.school
            ? `<div class="training-org">${edu.school}${edu.location ? `, ${edu.location}` : ""}</div>`
            : ""}
            ${edu.graduationDate
      ...
      ${data.sectionVisibility?.languages !== false &&
        ...
        <ul class="skills-list">
          ${data.languages
            .map((lang) => `<li>${lang.language || lang}${lang.level ? ` (${lang.level})` : ""}</li>`)
            .join("")}
        </ul>
      </div>`
        : ""}
      ...
      ${data.sectionVisibility?.socialLinks !== false &&
        ...
        ${data.socialLinks
            .map((link) => `<div class="contact-item"><a href="${link.url}" target="_blank">${link.urlText ||
            link.url.replace("https://", "").replace("http://", "")}</a></div>`)
            .join("")}
      </div>`
        : ""}
    </div>
