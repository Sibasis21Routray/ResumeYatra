...
function buildMinimalAtsTemplate(data, theme) {
    ...
    const parseSkills = () => {
        ...
        if (Array.isArray(data.skills))
            return data.skills.filter((s) => s && s.trim());
...
<div class="resume-wrapper">
  <div class="sidebar">
    ...
    <div class="sidebar-section" data-section="personal">
      ...
      ${data.personal?.dateOfBirth || data.personal?.dob
            ? `<div class="sidebar-item" data-section="personal"><strong>DOB:</strong> ${data.personal?.dateOfBirth || data.personal?.dob}</div>`
            : ""}
      ${data.personal?.gender
    ...
    <div class="sidebar-section" data-section="toolsTechnologies">
      ...
      ${nonEmptyToolsTechnologies
            .map((item, index) => `<div class="sidebar-item" data-section="toolsTechnologies" data-index="${index}">• ${item.name || ""}${item.proficiency ? ` (${item.proficiency})` : ""}${item.experienceDuration ? ` - ${item.experienceDuration}` : ""}</div>`)
            .join("")}
    </div>`
        : ""}
    ...
    <div class="sidebar-section" data-section="methodologies">
      ...
      ${nonEmptyMethodologies
            .map((item, index) => `<div class="sidebar-item" data-section="methodologies" data-index="${index}">• ${item.name || ""}${item.certification ? ` (${item.certification})` : ""}${item.experienceDuration ? ` - ${item.experienceDuration} years` : ""}</div>`)
            .join("")}
    </div>`
        : ""}
    ...
    <div class="sidebar-section" data-section="industryExpertise">
      ...
      ${nonEmptyIndustryExpertise
            .map((item, index) => `<div class="sidebar-item" data-section="industryExpertise" data-index="${index}">• ${item.industry || ""}${item.domainArea ? ` - ${item.domainArea}` : ""}${item.experienceDuration ? ` (${item.experienceDuration} years)` : ""}</div>`)
            .join("")}
    </div>`
        : ""}
  ...
  <div class="main-content" data-section="personal">
    <h1 class="header-name" data-section="personal">${data.personal?.name || "Your Name"}${data.personal?.middleName ? ` ${data.personal.middleName}` : ""}</h1>
    ...
    <div class="main-section" data-section="internships">
      ...
      ${nonEmptyInternships
        ...
        <div class="experience-item" data-section="internships" data-index="${index}">
          ...
          <div class="exp-sub" data-section="internships" data-field="company" data-index="${index}">${item.company || ''}</div>
          <div class="exp-desc" data-section="internships" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="trainingPrograms">
      ...
      ${nonEmptyTrainingPrograms
        ...
        <div class="experience-item" data-section="trainingPrograms" data-index="${index}">
          ...
          <div class="exp-sub" data-section="trainingPrograms" data-field="provider" data-index="${index}">${item.provider || item.organization || ''}${item.duration ? ` | ${item.duration}` : ''}</div>
          <div class="exp-desc" data-section="trainingPrograms" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
  ...
  ${edu.startDate || edu.graduationDate
          ...
          <div class="exp-sub" data-section="education" data-index="${index}">${edu.school || ''}${edu.location ? `, ${edu.location}` : ''}${edu.grade ? ` |  ${edu.grade}` : ''}</div>
    ...
    <div class="main-section" data-section="academicProjects">
      ...
      ${nonEmptyAcademicProjects
        ...
        <div class="experience-item" data-section="academicProjects" data-index="${index}">
          ...
          <div class="exp-sub" data-section="academicProjects" data-field="institution" data-index="${index}">${item.institution || item.course ? `Course: ${item.course}` : ''}</div>
          <div class="exp-desc" data-section="academicProjects" data-field="description" data-index="${index}">${item.description || ''}</div>
    ...
    <div class="main-section" data-section="clientProjects">
      ...
      ${nonEmptyClientProjects
        ...
        <div class="experience-item" data-section="clientProjects" data-index="${index}">
          ...
          <div class="exp-sub" data-section="clientProjects" data-field="client" data-index="${index}">${item.clientOrganization || ''}${item.role ? ` | Role: ${item.role}` : ''}</div>
          <div class="exp-desc" data-section="clientProjects" data-field="description" data-index="${index}">${item.description || ''}</div>
    ...
    <div class="main-section" data-section="portfolio">
      ...
      ${nonEmptyPortfolio
        ...
        <div class="experience-item" data-section="portfolio" data-index="${index}">
          ...
          <div class="exp-desc" data-section="portfolio" data-field="description" data-index="${index}">${item.description || ''}</div>
    ...
    <div class="main-section" data-section="leadershipPositions">
      ...
      ${nonEmptyLeadershipPositions
        ...
        <div class="experience-item" data-section="leadershipPositions" data-index="${index}">
          ...
          <div class="exp-desc" data-section="leadershipPositions" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="volunteering">
      ...
      ${nonEmptyVolunteering
        ...
        <div class="experience-item" data-section="volunteering" data-index="${index}">
          ...
          <div class="exp-sub" data-section="volunteering" data-field="organization" data-index="${index}">${item.organization || ''}${item.causeArea ? ` | ${item.causeArea}` : ''}</div>
          <div class="exp-desc" data-section="volunteering" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="militaryService">
      ...
      ${nonEmptyMilitaryService
        ...
        <div class="experience-item" data-section="militaryService" data-index="${index}">
          ...
          <div class="exp-sub" data-section="militaryService" data-field="specialization" data-index="${index}">${item.specialization || ''}</div>
          <div class="exp-desc" data-section="militaryService" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="teachingExperience">
      ...
      ${nonEmptyTeachingExperience
        ...
        <div class="experience-item" data-section="teachingExperience" data-index="${index}">
          ...
          <div class="exp-sub" data-section="teachingExperience" data-field="institution" data-index="${index}">${item.institution || ''}${item.subjectCourseTaught ? ` | ${item.subjectCourseTaught}` : ''}</div>
          <div class="exp-desc" data-section="teachingExperience" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="mentorshipExperience">
      ...
      ${nonEmptyMentorshipExperience
        ...
        <div class="experience-item" data-section="mentorshipExperience" data-index="${index}">
          ...
          <div class="exp-sub" data-section="mentorshipExperience" data-field="organization" data-index="${index}">${item.organizationPlatform || ''}${item.menteeLevel ? ` | Mentee Level: ${item.menteeLevel}` : ''}</div>
          <div class="exp-desc" data-section="mentorshipExperience" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="researchGrants">
      ...
      ${nonEmptyResearchGrants
        ...
        <div class="experience-item" data-section="researchGrants" data-index="${index}">
          ...
          <div class="exp-sub" data-section="researchGrants" data-field="agency" data-index="${index}">${item.agency || ''}${item.amount ? ` | Amount: ${item.amount}` : ''}</div>
          <div class="exp-desc" data-section="researchGrants" data-field="description" data-index="${index}">${item.description || ''}</div>
        </div>
      `)
            .join("")}
    </div>`
    ...
    <div class="main-section" data-section="publications">
      ...
      ${nonEmptyPublications
        ...
        <div class="experience-item" data-section="publications" data-index="${index}">
          ...
          <div class="exp-sub" data-section="publications" data-field="publisher" data-index="${index}">${item.journalPublisher || ''}${item.publicationType ? ` | ${item.publicationType}` : ''}</div>
    ...
    <div class="main-section" data-section="patents">
      ...
      ${nonEmptyPatents
        ...
        <div class="experience-item" data-section="patents" data-index="${index}">
          ...
          <div class="exp-sub" data-section="patents" data-field="patentNumber" data-index="${index}">${item.patentNumber || ''}${item.issuingAuthority ? ` | ${item.issuingAuthority}` : ''}</div>
    ...
    <div class="main-section" data-section="awards">
      ...
      ${nonEmptyAwards
        ...
        <div class="experience-item" data-section="awards" data-index="${index}">
          ...
          <div class="exp-sub" data-section="awards" data-field="organization" data-index="${index}">${item.organization || ''}</div>
    ...
    <div class="main-section" data-section="speakingEngagements">
      ...
      ${nonEmptySpeakingEngagements
        ...
        <div class="experience-item" data-section="speakingEngagements" data-index="${index}">
          ...
          <div class="exp-sub" data-section="speakingEngagements" data-field="event" data-index="${index}">${item.eventName || ''}</div>
          ${item.description ? `<div class="exp-desc">${item.description}</div>` : ''}
        </div>
      `)
            .join("")}
    ...
    <div class="main-section" data-section="memberships">
      ...
      ${nonEmptyMemberships
        ...
        <div class="experience-item" data-section="memberships" data-index="${index}">
          ...
          <div class="exp-sub" data-section="memberships" data-field="organization" data-index="${index}">${item.organizationName || ''}</div>
          ${item.description ? `<div class="exp-desc">${item.description}</div>` : ''}
        </div>
      `)
            .join("")}
    ...
    <div class="main-section" data-section="workshops">
      ...
      ${nonEmptyWorkshops
        ...
        <div class="experience-item" data-section="workshops" data-index="${index}">
          ...
          <div class="exp-sub" data-section="workshops" data-field="conductedBy" data-index="${index}">${item.conductedBy || ''}</div>
          ${item.description ? `<div class="exp-desc">${item.description}</div>` : ''}
        </div>
      `)
            .join("")}
    ...
    <div class="main-section" data-section="scholarships">
      ...
      ${nonEmptyScholarships
        ...
        <div class="experience-item" data-section="scholarships" data-index="${index}">
          ...
          <div class="exp-sub" data-section="scholarships" data-field="provider" data-index="${index}">${item.provider || item.organization || ''}</div>
          ${item.description ? `<div class="exp-desc">${item.description}</div>` : ''}
        </div>
      `)
            .join("")}
