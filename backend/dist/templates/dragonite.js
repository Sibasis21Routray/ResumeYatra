...
exports.buildDragoniteTemplate = buildDragoniteTemplate;
function buildDragoniteTemplate(data, theme) {
    const defaultTheme = {
        primary: '#000000',
        secondary: '#444444',
        background: '#ffffff',
    ...
    <div class="contact" data-section="personal">
      ...
      ${(() => {
        ...
        if (data.personal?.fathersName)
            personalDetails.push(`<span data-section="personal">👨 Father: ${data.personal.fathersName}</span>`);
        if (data.personal?.dob)
            personalDetails.push(`<span data-section="personal">📅 DOB: ${data.personal.dob}</span>`);
        if (data.personal?.gender)
            personalDetails.push(`<span data-section="personal">⚥ Gender: ${data.personal.gender}</span>`);
        if (data.personal?.maritalStatus)
            personalDetails.push(`<span data-section="personal">💍 Marital: ${data.personal.maritalStatus}</span>`);
        if (data.personal?.nationality)
            personalDetails.push(`<span data-section="personal">🌍 Nationality: ${data.personal.nationality}</span>`);
        if (data.personal?.passportNo)
            personalDetails.push(`<span data-section="personal">🛂 Passport: ${data.personal.passportNo}</span>`);
