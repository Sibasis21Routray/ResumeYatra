    ...
    <div class="header-contact-bar" data-section="personal">
      ...
      ${(() => {
        ...
        if (data.personal?.fathersName)
            personalDetails.push(`<span class="contact-item" data-section="personal">Father: ${data.personal.fathersName}</span>`);
        if (data.personal?.dob)
            personalDetails.push(`<span class="contact-item" data-section="personal">DOB: ${data.personal.dob}</span>`);
        if (data.personal?.gender)
            personalDetails.push(`<span class="contact-item" data-section="personal">Gender: ${data.personal.gender}</span>`);
        if (data.personal?.maritalStatus)
            personalDetails.push(`<span class="contact-item" data-section="personal">Marital: ${data.personal.maritalStatus}</span>`);
        if (data.personal?.nationality)
            personalDetails.push(`<span class="contact-item" data-section="personal">Nationality: ${data.personal.nationality}</span>`);
        if (data.personal?.passportNo)
            personalDetails.push(`<span class="contact-item" data-section="personal">Passport: ${data.personal.passportNo}</span>`);
    ...
    <div class="content-wrapper">
      ...
      <div class="section" data-section="skills">
        ...
        <div class="skills-list" data-section="skills">
          ${nonEmptySkills.map((skill, index) => `<span class="skill-tag" data-section="skills" data-index="${index}">${typeof skill === "string" ? skill.trim() : skill}</span>`).join("")}
        </div>
      </div>` : ""}
      ...
      <div class="section" data-section="languages">
        ...
        <div class="skills-list" data-section="languages">
          ${nonEmptyLanguages.map((lang, index) => `<span class="skill-tag" data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}</span>`).join("")}
        </div>
      </div>` : ""}
      ...
      <div class="section" data-section="hobbies">
        ...
        <div class="skills-list" data-section="hobbies">
          ${nonEmptyHobbies.map((hobby, index) => `<span class="skill-tag" data-section="hobbies" data-index="${index}">${hobby}</span>`).join("")}
        </div>
      </div>` : ""}
