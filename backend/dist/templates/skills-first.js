  ...
  <div class="main-grid">
    <div class="sidebar">
      ...
      <div class="sidebar-box" data-section="expertise">
        ...
        ${nonEmptyKeyAchievements.slice(0, 4).map((item, index) => `
    ...
    <div class="content-main">
      ...
      <div class="section" data-section="languages">
        ...
        <p style="font-size: 9pt;">${nonEmptyLanguages.map((lang) => `${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}`).join(", ")}</p>
      </div>` : ''}
      ...
      <div class="section" data-section="keyAchievements">
        ...
        <ul>
          ${nonEmptyKeyAchievements.map((achievement, index) => `<li style="font-size: 9pt;" data-section="keyAchievements" data-index="${index}">${achievement}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="section" data-section="responsibilities">
        ...
        <ul>
          ${nonEmptyResponsibilities.map((line, index) => `<li style="font-size: 9pt;" data-section="responsibilities" data-index="${index}">${line.trim()}</li>`).join('')}
        </ul>
      </div>` : ''}
