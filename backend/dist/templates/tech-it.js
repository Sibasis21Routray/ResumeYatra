...
<div class="resume-container">
  ...
  <div class="main-section" data-section="responsibilities">
    ...
    <ul>
      ${nonEmptyResponsibilities.map((resp, index) => `<li data-section="responsibilities" data-index="${index}">${resp}</li>`).join('')}
    </ul>
  </div>` : ''}
  ...
  <div class="main-section" data-section="tools">
    <div class="section-title">Tools & Technologies</div>
    <ul>
      ${nonEmptyTools.map((tool, index) => `<li data-section="tools" data-index="${index}">${tool}</li>`).join('')}
    </ul>
  </div>` : ''}
