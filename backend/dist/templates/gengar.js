  ...
  <div class="container">
    ...
    <div class="header" data-section="personal">
      ...
      <div class="header-content" data-section="personal">
        ...
        ? data.personal.name
        : "Your Name"}${data.personal?.middleName ? ` ${data.personal.middleName}` : ""}</div>
        ${data.personal?.role
        ...
        if (data.personal?.linkedinUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.linkedinUrl}" target="_blank">🔗 LinkedIn</a></div>`);
        if (data.personal?.githubUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.githubUrl}" target="_blank">🐙 GitHub</a></div>`);
        if (data.personal?.portfolioUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.portfolioUrl}" target="_blank">💼 Portfolio</a></div>`);
        if (data.personal?.website)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.website}" target="_blank">🌐 Website</a></div>`);
        if (data.personal?.twitterUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.twitterUrl}" target="_blank">🐦 Twitter</a></div>`);
        if (data.personal?.facebookUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.facebookUrl}" target="_blank">📘 Facebook</a></div>`);
        if (data.personal?.instagramUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.instagramUrl}" target="_blank">📷 Instagram</a></div>`);
        if (data.personal?.behanceUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.behanceUrl}" target="_blank">🎨 Behance</a></div>`);
        if (data.personal?.dribbbleUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.dribbbleUrl}" target="_blank">🏀 Dribbble</a></div>`);
        if (data.personal?.stackoverflowUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.stackoverflowUrl}" target="_blank">📚 Stack Overflow</a></div>`);
        if (data.personal?.mediumUrl)
            socialLinks.push(`<div class="contact-item" data-section="contact"><a href="${data.personal.mediumUrl}" target="_blank">📝 Medium</a></div>`);
        ...
        if (data.personal?.personalInfoDisplay === "inline") {
            if (data.personal?.fathersName)
                inlineItems.push(`<div class="contact-item" data-section="contact">👨 Father: ${data.personal.fathersName}</div>`);
            if (data.personal?.dob)
                inlineItems.push(`<div class="contact-item" data-section="contact">📅 DOB: ${data.personal.dob}</div>`);
            if (data.personal?.gender)
                inlineItems.push(`<div class="contact-item" data-section="contact">⚥ Gender: ${data.personal.gender}</div>`);
            if (data.personal?.maritalStatus)
                inlineItems.push(`<div class="contact-item" data-section="contact">💍 Marital: ${data.personal.maritalStatus}</div>`);
            if (data.personal?.nationality)
                inlineItems.push(`<div class="contact-item" data-section="contact">🌍 Nationality: ${data.personal.nationality}</div>`);
        }
    ...
    <div class="content-wrapper">
      ...
      <div class="section" data-section="keyAchievements">
        ...
        <div class="entry-content" data-section="keyAchievements">
          <ul data-section="keyAchievements">
            ${nonEmptyKeyAchievements.map((achievement, index) => `<li data-section="keyAchievements" data-index="${index}">${achievement}</li>`).join("")}
          </ul>
        </div>
      </div>` : ""}
      ...
      <div class="section" data-section="responsibilities">
        ...
        <div class="entry-content" data-section="responsibilities">
          <ul data-section="responsibilities">
            ${nonEmptyResponsibilities.map((line, index) => `<li data-section="responsibilities" data-index="${index}">${line.trim()}</li>`).join("")}
          </ul>
        </div>
      </div>` : ""}
      ...
      <div class="section" data-section="tools">
        ...
        <div class="entry-content" data-section="tools">
          <ul data-section="tools">
            ${nonEmptyTools.map((line, index) => `<li data-section="tools" data-index="${index}">${line.trim()}</li>`).join("")}
          </ul>
        </div>
      </div>` : ""}
      ...
      ${nonEmptyCustomSections.length > 0 ? data.customSections
        ...
        .filter((entry) => entry.isVisible && (entry.title || entry.description))
