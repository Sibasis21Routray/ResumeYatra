...
exports.buildImpactResumeTemplate = buildImpactResumeTemplate;
function buildImpactResumeTemplate(data, theme) {
    ...
    const getProficiencyPills = (level) => {
        const levels = {
      ...
      <div class="container">
        <div class="main-col">
          ...
          <div class="section" data-section="mentorshipExperience">
            ...
            <ul class="simple-list">
              ${nonEmptyMentorshipExperience.map((item, idx) => `<li data-index="${idx}"><strong>${item.mentorshipArea || ''}</strong>${item.organizationPlatform ? ` @ ${item.organizationPlatform}` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="speakingEngagements">
            ...
            <ul class="simple-list">
              ${nonEmptySpeakingEngagements.map((item, idx) => `<li data-index="${idx}"><strong>${item.topic || item.title || ''}</strong>${item.eventName ? ` at ${item.eventName}` : ''}${item.date ? ` (${item.date})` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="researchGrants">
            ...
            <ul class="simple-list">
              ${nonEmptyResearchGrants.map((item, idx) => `<li data-index="${idx}"><strong>${item.title || ''}</strong> - ${item.agency || ''}${item.amount ? ` (${item.amount})` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="portfolio">
            ...
            <ul class="simple-list">
              ${nonEmptyPortfolio.map((item, idx) => `<li data-index="${idx}"><a href="${item.url}" style="color: ${currentTheme.primary};">${item.name || item.title || 'Portfolio'}</a></li>`).join('')}
            </ul>
          </div>
          ` : ''}
        </div>
        ...
        <div class="side-col">
          ...
          <div class="section" data-section="toolsTechnologies">
            ...
            <p class="skill-text">${nonEmptyToolsTechnologies.map((t) => t.name || t).join(', ')}</p>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="methodologies">
            ...
            <p class="skill-text">${nonEmptyMethodologies.map((m) => m.name).join(', ')}</p>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="industryExpertise">
            ...
            <p class="skill-text">${nonEmptyIndustryExpertise.map((i) => i.industry).join(', ')}</p>
          </div>
          ` : ''}
        ...
        return `
          ...
          <div class="section" data-section="activities">
            ...
            <ul class="simple-list">
              ${[...nonEmptyCoCurricular, ...nonEmptyExtracurricular].map((item, idx) => `<li data-index="${idx}"><strong>${item.activity || ''}</strong>${item.role ? ` — ${item.role}` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="hobbies">
            ...
            <p class="skill-text">${nonEmptyHobbies.map((h) => typeof h === 'string' ? h : h.name).join(', ')}</p>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="memberships">
            ...
            <ul class="simple-list">
              ${nonEmptyMemberships.map((item, idx) => `<li data-index="${idx}"><strong>${item.organizationName || item.organization || ''}</strong>${item.role ? ` — ${item.role}` : ''}</li>`).join('')}
            </ul>
          </div>
          ` : ''}
          ...
          <div class="section" data-section="socialProfiles">
            ...
            <ul class="simple-list">
              ${nonEmptySocialProfiles.map((item, idx) => `<li data-index="${idx}"><a href="${item.url}" style="color: ${currentTheme.primary};">${item.platform || 'Profile'}</a></li>`).join('')}
            </ul>
          </div>
          ` : ''}
        </div>
