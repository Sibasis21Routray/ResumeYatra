  ...
  <div class="resume-container">
    <div class="sidebar">
      ...
      <div class="sidebar-section" data-section="skills">
        ...
        <ul class="skill-list">
          ${nonEmptySkills.map((s, index) => `<li data-section="skills" data-index="${index}">${typeof s === 'string' ? s.trim() : s}</li>`).join('')}
        </ul>
      </div>` : ''}
      ...
      <div class="sidebar-section" data-section="languages">
        ...
        <ul class="skill-list">
          ${nonEmptyLanguages.map((lang, index) => `<li data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}</li>`).join('')}
        </ul>
      </div>` : ''}
