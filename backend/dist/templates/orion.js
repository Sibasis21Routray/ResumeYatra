        ...
        ${(data.internships || [])
          ...
          <div class="entry">
            <div class="entry-header">
              ...
              <span style="font-weight: 400; font-size: 0.9em;">${item.startDate || ""} — ${item.endDate || ""}</span>
            </div>
            <div class="entry-sub">${item.title || ""}${item.location ? ` | ${item.location}` : ""}</div>
        ...
        ${(data.academicProjects || [])
          ...
          <div class="entry">
            <div class="entry-header">
              ...
              <span style="font-weight: 400; font-size: 0.9em;">${item.duration || ""}</span>
            </div>
      ...
      <div class="entry" data-section="trainingPrograms">
        ...
        ${(data.trainingPrograms || [])
          ...
          <div class="entry">
            <div class="entry-header">
              <span>${item.name || ""}</span>
              <span style="font-weight: 400; font-size: 0.9em;">${item.completionDate || ""}</span>
            </div>
      ...
      <div class="entry" data-section="scholarships">
        ...
        ${(data.scholarships || [])
          ...
          <div class="entry">
            <div class="entry-header">
              <span>${item.name || ""}</span>
              <span style="font-weight: 400; font-size: 0.9em;">${item.year || ""}</span>
            </div>
        ...
        ${(data.coCurricular || [])
          ...
          <div class="entry">
            <div class="entry-header">
              ...
              <span style="font-weight: 400; font-size: 0.9em;">${item.year ||
