    ...
    <div class="left-column">
      ...
      ${(() => {
        ...
        if (data.personal?.fathersName)
            personalDetails.push(`<div><strong>Father's Name:</strong> ${data.personal.fathersName}</div>`);
        if (data.personal?.dob)
            personalDetails.push(`<div><strong>Date of Birth:</strong> ${data.personal.dob}</div>`);
        if (data.personal?.gender)
            personalDetails.push(`<div><strong>Gender:</strong> ${data.personal.gender}</div>`);
        if (data.personal?.maritalStatus)
            personalDetails.push(`<div><strong>Marital Status:</strong> ${data.personal.maritalStatus}</div>`);
        if (data.personal?.nationality)
            personalDetails.push(`<div><strong>Nationality:</strong> ${data.personal.nationality}</div>`);
        if (data.personal?.passportNo)
            personalDetails.push(`<div><strong>Passport No:</strong> ${data.personal.passportNo}</div>`);
      ...
      <div class="section" data-section="skills">
        ...
        <ul class="skills-list">
          ${nonEmptySkills.map((skill, index) => `<li class="skill-item" data-section="skills" data-index="${index}">${typeof skill === "string" ? skill.trim() : skill}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="toolsTechnologies">
        ...
        <ul class="skills-list">
          ${nonEmptyToolsTechnologies.map((item, index) => `<li class="skill-item" data-section="toolsTechnologies" data-index="${index}">${item.name || ''}${item.proficiency ? ` (${item.proficiency})` : ''}${item.experienceDuration ? ` - ${item.experienceDuration}` : ''}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="methodologies">
        ...
        <ul class="skills-list">
          ${nonEmptyMethodologies.map((item, index) => `<li class="skill-item" data-section="methodologies" data-index="${index}">${item.name || ''}${item.certification ? ` (${item.certification})` : ''}${item.experienceDuration ? ` - ${item.experienceDuration} years` : ''}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="industryExpertise">
        ...
        <ul class="skills-list">
          ${nonEmptyIndustryExpertise.map((item, index) => `<li class="skill-item" data-section="industryExpertise" data-index="${index}">${item.industry || ''}${item.domainArea ? ` - ${item.domainArea}` : ''}${item.experienceDuration ? ` (${item.experienceDuration} years)` : ''}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="languages">
        ...
        <ul class="skills-list">
          ${nonEmptyLanguages.map((lang, index) => `<li class="skill-item" data-section="languages" data-index="${index}">${lang.language || lang}${lang.level ? ` (${lang.level})` : ''}${lang.capability ? ` - ${lang.capability}` : ''}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="hobbies">
        ...
        <ul class="skills-list">
          ${nonEmptyHobbies.map((hobby, index) => `<li class="skill-item" data-section="hobbies" data-index="${index}">${hobby}</li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="socialLinks">
        ...
        <ul class="skills-list">
          ${nonEmptySocialLinks.map((link, index) => `<li class="skill-item" data-section="socialLinks" data-index="${index}"><a href="${link.url}" target="_blank" style="color: var(--secondary-color); text-decoration: none;">${link.urlText || link.url.replace('https://', '').replace('http://', '')}</a></li>`).join("")}
        </ul>
      </div>` : ""}
      ...
      <div class="section" data-section="socialProfiles">
        ...
        <ul class="skills-list">
          ${nonEmptySocialProfiles.map((profile, index) => `<li class="skill-item" data-section="socialProfiles" data-index="${index}"><a href="${profile.url}" target="_blank" style="color: var(--secondary-color); text-decoration: none;">${profile.platform || "Profile"}</a></li>`).join("")}
        </ul>
      </div>` : ""}
