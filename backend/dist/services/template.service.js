...
const impactResume_1 = require("../templates/impactResume");
const startup_Tech_1 = require("../templates/startup&Tech");
const modernCorporate_1 = require("../templates/modernCorporate");
const seniorLeadership_1 = require("../templates/seniorLeadership");
const corporateStandard_1 = require("../templates/corporateStandard");
...
function buildHtml(data, template, theme) {
    switch (template) {
        ...
        case "impact-resume":
            return (0, impactResume_1.buildImpactResumeTemplate)(data, theme);
        case "startup-tech":
            return (0, startup_Tech_1.buildStartupAndTechTemplate)(data, theme);
        case "modern-corporate":
            return (0, modernCorporate_1.buildModernCorporateTemplate)(data, theme);
        case "senior-leadership":
            return (0, seniorLeadership_1.buildSeniorLeadershipTemplate)(data, theme);
        case "corporate-standard":
            return (0, corporateStandard_1.buildCorporateStandardTemplate)(data, theme);
        case "saanvi-patel":
