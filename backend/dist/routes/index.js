...
router.use('/resumes', auth_middleware_1.optionalAuthMiddleware, resumes_1.default);
router.use('/admin', auth_middleware_1.authMiddleware, admin_1.default);
router.use("/payment", auth_middleware_1.optionalAuthMiddleware, payment_1.default);
