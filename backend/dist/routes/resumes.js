...
router.post("/", subscription_middleware_1.subscriptionMiddleware, resume_controller_1.createResume);
router.get("/", subscription_middleware_1.subscriptionMiddleware, resume_controller_1.listResumes);
router.get("/:id", resume_controller_1.getResume);
router.patch("/:id/rename", resume_controller_1.renameResume);
router.put("/:id", subscription_middleware_1.subscriptionMiddleware, resume_controller_1.updateResume);
router.delete("/:id", subscription_middleware_1.subscriptionMiddleware, resume_controller_1.deleteResume);
// Upload and parse original resume file
router.post("/upload", subscription_middleware_1.subscriptionMiddleware, upload_middleware_1.uploadMiddleware, upload_controller_1.uploadResume);
...
// Mark as paid (manual/frontend-driven)
router.post("/:id/mark-paid", resume_controller_1.markPaid);
router.post("/mark-paid/:id", resume_controller_1.markPaid);
// Mark as downloaded after AI enhancement
router.post("/:id/mark-downloaded", resume_controller_1.markDownloaded);
// Export endpoints
